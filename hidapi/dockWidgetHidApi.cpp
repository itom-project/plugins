...
//-------------------------------------------------------------------------------------------------------------------------------------------------
DockWidgetHidApi::DockWidgetHidApi(QMap<QString, ito::Param> params, int uniqueID)
{
    ui.setupUi(this);
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
 void DockWidgetHidApi::valuesChanged(QMap<QString, ito::Param> params)
{
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
/* void DockWidgetHidApi::uniqueIDChanged(const int uniqueID)
{
    ui.lblID->setText(QString::number(uniqueID));
}*/

//-------------------------------------------------------------------------------------------------------------------------------------------------
void DockWidgetHidApi::on_ClrButton_clicked()
{
    ui.textTransfer->clear();
}

//-------------------------------------------------------------------------------------------------------------------------------------------------
void DockWidgetHidApi::serialLog(QByteArray data, const char InOutChar)
{
