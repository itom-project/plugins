...
and input lines of the HID commonication. In order to start a commoncation via the feature port, set the parameter **use_feature_report_not_output** to 1 (instead of 0).
