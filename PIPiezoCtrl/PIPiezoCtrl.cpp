...
//    retval += PIDummyRead();
    ...
    if (answer.contains("E-662"))
    {
        ...
        m_params["ctrlType"].setVal<char*>(tr("E662").toLatin1().data(), (int)strlen("E662"));
    ...
    else if (answer.contains("C-663"))
    {
        ...
        m_params["ctrlType"].setVal<char*>(tr("C663").toLatin1().data(), (int)strlen("C663"));
    ...
    else if (answer.contains("E816") || answer.contains("E625"))
    {
        ...
        {
            m_params["ctrlType"].setVal<char*>(tr("E816").toLatin1().data(), (int)strlen("E816"));
            m_params["hasOnTargetFlag"].setVal<int>(1.0);
        }
        else if (answer.contains("E625"))
        {
            m_params["ctrlType"].setVal<char*>(tr("E625").toLatin1().data(), (int)strlen("E625"));
            m_params["hasOnTargetFlag"].setVal<int>(1.0);
        }
    ...
    else if (answer.contains("E-753"))
    {
        ...
        m_params["ctrlType"].setVal<char*>(tr("E753").toLatin1().data());
        m_params["hasOnTargetFlag"].setVal<int>(1.0);
