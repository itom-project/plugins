...
//----------------------------------------------------------------------------------------------------------------------------------
int dialogDummyGrabber::getVals(QMap<QString, ito::Param> *paramVals)
{
...
//    bool updateSizeY = false
    ...
    foreach(const ito::Param &param, *paramVals)
    {
        ...
        if(!strcmp(param.getName(), "x1"))
        {
            ...
            if(!(param.getFlags() & ito::ParamBase::Readonly))
            {
                ui.btnResetROI->setEnabled(true);
        ...
        if(!strcmp(param.getName(), "sizex"))
        {
            ...
            ui.lbl_xsize->setText( QString::number(ival) );
        }
        ...
        if(!strcmp(param.getName(), "sizey"))
        {
            ...
            ui.lbl_ysize->setText( QString::number(ival) );
        }
...
//----------------------------------------------------------------------------------------------------------------------------------
int dialogDummyGrabber::sendVals()
{
...
//----------------------------------------------------------------------------------------------------------------------------------
void dialogDummyGrabber::valuesChanged(QMap<QString, ito::Param> params)
{
    getVals(&params);
}
//----------------------------------------------------------------------------------------------------------------------------------
 ...
 * \warning    NA
*/
void dialogDummyGrabber::on_btnResetROI_clicked()
{
    int inttemp = 0;
 ...
 * \warning    NA
*/
void dialogDummyGrabber::on_applyButton_clicked()
{
    ui.groupBoxROI->setTitle( tr("Region of Interest (ROI)") );
    ui.groupBoxROI->setEnabled(true);
    sendVals();
}
//----------------------------------------------------------------------------------------------------------------------------------
/**
 ...
 * \warning    NA
*/
void dialogDummyGrabber::on_spinBox_x0_valueChanged(int value)
{
 ...
 * \warning    NA
*/
void dialogDummyGrabber::on_spinBox_x1_valueChanged(int value)
{
 ...
 * \warning    NA
*/
void dialogDummyGrabber::on_spinBox_y0_valueChanged(int value)
{
 ...
 * \warning    NA
*/
void dialogDummyGrabber::on_spinBox_y1_valueChanged(int value)
{
 ...
 * \warning    NA
*/
void dialogDummyGrabber::on_spinBox_binX_valueChanged(int /*value*/)
{
    ui.groupBoxROI->setTitle( tr("ROI (Binning changed, press apply or save)") );
    ui.groupBoxROI->setEnabled(false);
 ...
 * \warning    NA
*/
void dialogDummyGrabber::on_spinBox_binY_valueChanged(int /*value*/)
{
    ui.groupBoxROI->setTitle( tr("ROI (Binning changed, press apply or save)") );
    ui.groupBoxROI->setEnabled(false);
    return;
