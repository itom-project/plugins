...
*\sa DummyMotor
*/
DockWidgetAerotechA3200::DockWidgetAerotechA3200(QMap<QString, ito::Param> params, int uniqueID, ito::AddInActuator *actuator) :
    m_actuator(actuator),
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
void DockWidgetAerotechA3200::CheckAxisNums(QMap<QString, ito::Param> params)
{
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
void DockWidgetAerotechA3200::init(QMap<QString, ito::Param> params, QStringList axisNames)
{
    if (m_initialized)
    {
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
void DockWidgetAerotechA3200::targetChanged(QVector<double> targetPositions)
{
    if (!m_initialized)
    {
        return;
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
void DockWidgetAerotechA3200::actuatorStatusChanged(QVector<int> status, QVector<double> actPosition)
{
    int i = 0;
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
void DockWidgetAerotechA3200::checkEnabledClicked(const int &index)
{
    if (!m_initialized)
    {
        return;
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
/*void DockWidgetAerotechA3200::MoveRelative(const int &index, const double dpos)
{
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
void DockWidgetAerotechA3200::Move(const QVector<int> axis, const QVector<double> dpos, const char* func)
{
    ItomSharedSemaphore *waitCond = new ItomSharedSemaphore();
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
void DockWidgetAerotechA3200::posIncrementClicked(const int &index)
{
    if (!m_initialized)
    {
        return;
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
void DockWidgetAerotechA3200::posDecrementClicked(const int &index)
{
    if (!m_initialized)
    {
        return;
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
void DockWidgetAerotechA3200::enableWidget(bool enabled)
{
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
void DockWidgetAerotechA3200::on_pb_Start_clicked()
{
    QVector<int> axis;
    QVector<double> dpos;
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
void DockWidgetAerotechA3200::on_pb_Stop_clicked()
{
    if (m_actuator) m_actuator->setInterrupt();
}

//-------------------------------------------------------------------------------------------------------------------------------------------------
void DockWidgetAerotechA3200::on_pb_Refresh_clicked()
{
