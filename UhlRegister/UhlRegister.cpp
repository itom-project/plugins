...
//----------------------------------------------------------------------------------------------------------------------------------
    ...
    Q_EXPORT_PLUGIN2(UhlRegisterInterface, UhlRegisterInterface)
#endif
...
/*    
    ...
    connect(UhlWid, SIGNAL(MotorTriggerStatusRequest(bool,bool)), this, SLOT(RequestStatusAndPosition(bool,bool)));
