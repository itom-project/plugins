...
//-------------------------------------------------------------------------------------------------------------------------------------------------
DockWidgetItomCyUSB::DockWidgetItomCyUSB(QMap<QString, ito::Param> params, int uniqueID)
{
    ui.setupUi(this);
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
 void DockWidgetItomCyUSB::valuesChanged(QMap<QString, ito::Param> params)
{
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
/* void DockWidgetItomCyUSB::uniqueIDChanged(const int uniqueID)
{
    ui.lblID->setText(QString::number(uniqueID));
}*/

//-------------------------------------------------------------------------------------------------------------------------------------------------
void DockWidgetItomCyUSB::on_ClrButton_clicked()
{
    ui.textTransfer->clear();
}

//-------------------------------------------------------------------------------------------------------------------------------------------------
void DockWidgetItomCyUSB::serialLog(QByteArray data, const char InOutChar)
{
