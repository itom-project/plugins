...
/**
  @file Doxygen.cpp
  @brief Title page of documentation, no source code.
*/

/**
  @mainpage openGPS ISO 5436-2 XML Library Documentation

  @image html openGPS_Logo_Final0072.png
  @image latex openGPS_Logo_Final.pdf width=10cm
