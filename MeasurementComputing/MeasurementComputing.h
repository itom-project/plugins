...
class MeasurementComputing : public ito::AddInDataIO
{
    ...
    protected:
        ...
        //bool taskCreated;                            // 0: task has not been created, 1: task has succesfully been created
        //bool taskStarted;                            // 0: task has not been started, 1: task has succesfully been started
