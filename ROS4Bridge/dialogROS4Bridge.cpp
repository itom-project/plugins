...
#endif
//----------------------------------------------------------------------------------------------------------------------------------
QString dialogROS4Bridge::interpretAnswer(const char* temp, const int templen)
{
    QString ret = "";
...
//----------------------------------------------------------------------------------------------------------------------------------
/*int dialogROS4Bridge::setVals(QMap<QString, ito::Param> *params)
{
...
//----------------------------------------------------------------------------------------------------------------------------------
void dialogROS4Bridge::parametersChanged(QMap<QString, ito::Param> params)
{
    QString BaudStr = QString::number((params)["baud"].getVal<int>());
    int i = 0;
    while (i < ui.combo_baud->count() && ui.combo_baud->itemText(i) != BaudStr)
...
//----------------------------------------------------------------------------------------------------------------------------------
ito::RetVal dialogROS4Bridge::applyParameters()
{
...
//---------------------------------------------------------------------------------------------------------------------
/*int dialogROS4Bridge::getVals(int &baud, QString &endline, int &bits, int &stopbits, int &parity,
...
//----------------------------------------------------------------------------------------------------------------------------------
// dialogROS4Bridge::dialogROS4Bridge(void *sport, QString identifier) :
//    m_psport(sport)
dialogROS4Bridge::dialogROS4Bridge(
    ...
    m_psport(sport)
{
    ...
    ROS4Bridge* sio = (ROS4Bridge*)m_psport;
...
//----------------------------------------------------------------------------------------------------------------------------------
ito::RetVal dialogROS4Bridge::parseOutString(char* buf, int* length)
{
...
//----------------------------------------------------------------------------------------------------------------------------------
/*
 bool dialogROS4Bridge::on_lineEditSend_eventFilter(QObject *obj, QEvent *event)
 {
...
*/
//----------------------------------------------------------------------------------------------------------------------------------
void dialogROS4Bridge::on_lineEditSend_returnPressed()
{
    ito::RetVal ret;
    QString qstr, qout;
    char endline[3] = {0, 0, 0};
...
//----------------------------------------------------------------------------------------------------------------------------------
void dialogROS4Bridge::on_pushButtonSet_clicked()
{
    applyParameters();
    /*    int baud;
        int bits;
...
//----------------------------------------------------------------------------------------------------------------------------------
void dialogROS4Bridge::on_pushButtonCreateCommand_clicked()
{
    char txt[150];
    ito::RetVal ret;
...
//----------------------------------------------------------------------------------------------------------------------------------
void dialogROS4Bridge::on_pushSendButton_clicked()
{
...
//----------------------------------------------------------------------------------------------------------------------------------
void dialogROS4Bridge::on_pushReadButton_clicked()
{
    ito::RetVal ret;
    int maxlen = 255;
    QSharedPointer<char> readBuf(new char[maxlen]);
...
//----------------------------------------------------------------------------------------------------------------------------------
void dialogROS4Bridge::on_cancelButton_clicked()
{
    ito::RetVal ret;
    ROS4Bridge* sio = (ROS4Bridge*)m_psport;
...
//----------------------------------------------------------------------------------------------------------------------------------
void dialogROS4Bridge::on_okButton_clicked()
{
    on_pushButtonSet_clicked();
}

//----------------------------------------------------------------------------------------------------------------------------------
void dialogROS4Bridge::on_pushButton_clear_clicked()
{
...
//----------------------------------------------------------------------------------------------------------------------------------
bool dialogROS4Bridge::eventFilter(QObject* obj, QEvent* event)
{
