...
//
//typedef DWORD (__stdcall* MPUSBGETDLLVERSION)(void);
//MPUSBGETDLLVERSION MPUSBGetDLLVersion = 0;
...
//
//typedef DWORD (__stdcall* MPUSBGETDEVICECOUNT)(PCHAR);
//MPUSBGETDEVICECOUNT MPUSBGetDeviceCount = 0;
...
//	perspective of an application making the calls.
//
//typedef HANDLE (__stdcall* MPUSBOPEN)(DWORD, PCHAR, PCHAR, DWORD, DWORD);
//MPUSBOPEN MPUSBOpen = 0;
...
//	perspective of an application making the calls.
//
//typedef DWORD (__stdcall* MPUSBREAD)(HANDLE, PVOID, DWORD, PDWORD, DWORD);
//MPUSBREAD MPUSBRead = 0;
...
//	perspective of an application making the calls.
//
//typedef DWORD (__stdcall* MPUSBWRITE)(HANDLE, PVOID, DWORD, PDWORD, DWORD);
//MPUSBWRITE MPUSBWrite = 0;
...
//	perspective of an application making the calls.
//
//typedef DWORD (__stdcall* MPUSBREADINT)(HANDLE, PVOID, DWORD, PDWORD, DWORD);
//MPUSBREADINT MPUSBReadInt = 0;
...
//	perspective of an application making the calls.
//
//typedef BOOL (__stdcall* MPUSBCLOSE)(HANDLE);
//MPUSBCLOSE MPUSBClose = 0;
...
//	perspective of an application making the calls.
//
//typedef DWORD (__stdcall* MPUSBGETDEVICEDESCRIPTOR)(HANDLE, PVOID, DWORD, PDWORD);
//MPUSBGETDEVICEDESCRIPTOR MPUSBGetDeviceDescriptor = 0;
...
//	perspective of an application making the calls.
//
//typedef DWORD (__stdcall* MPUSBGETCONFIGURATIONDESCRIPTOR)(HANDLE, UCHAR, PVOID, DWORD, PDWORD);
//MPUSBGETCONFIGURATIONDESCRIPTOR MPUSBGetConfigurationDescriptor = 0;
...
//	perspective of an application making the calls.
//
//typedef DWORD (__stdcall* MPUSBGETSTRINGDESCRIPTOR)(HANDLE, UCHAR, USHORT, PVOID, DWORD, PDWORD);
//MPUSBGETSTRINGDESCRIPTOR MPUSBGetStringDescriptor = 0;
...
//	perspective of an application making the calls.
//
//typedef DWORD (__stdcall* MPUSBSETCONFIGURATION)(HANDLE, USHORT);
//MPUSBSETCONFIGURATION MPUSBSetConfiguration = 0;
