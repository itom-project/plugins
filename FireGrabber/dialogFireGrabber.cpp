...
//----------------------------------------------------------------------------------------------------------------------------------
int dialogFireGrabber::getVals(QMap<QString, ito::Param> *paramVals)
{
...
//----------------------------------------------------------------------------------------------------------------------------------
int dialogFireGrabber::sendVals()
{
...
//----------------------------------------------------------------------------------------------------------------------------------
void dialogFireGrabber::valuesChanged(QMap<QString, ito::Param> params)
{
    getVals(&params);
    return;
}
