...
class dialogPCOCamera : public QDialog 
{
    Q_OBJECT

    public:
        dialogPCOCamera(ito::AddInGrabber *grabber):m_Grabber(grabber){m_paramsVals.clear(); ui.setupUi(this);};
        ~dialogPCOCamera() {m_paramsVals.clear();};
