...
//----------------------------------------------------------------------------------------------------------------------------------
DockWidgetTucsen::DockWidgetTucsen(ito::AddInDataIO* grabber) :
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetTucsen::parametersChanged(QMap<QString, ito::Param> params)
{
    if (m_firstRun)
    {
...
void DockWidgetTucsen::on_sW_Gain_valueChanged(double d)
{
    if (!m_inEditing)
    {
        m_inEditing = true;
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetTucsen::on_sW_IntTime_valueChanged(double d)
{
    if (!m_inEditing)
    {
        m_inEditing = true;
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetTucsen::on_sW_Offset_valueChanged(double d)
{
    if (!m_inEditing)
    {
        m_inEditing = true;
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetTucsen::on_check_GainAuto_toggled(bool checked)
{
    if (!m_inEditing)
    {
        m_inEditing = true;
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetTucsen::identifierChanged(const QString& identifier)
{
