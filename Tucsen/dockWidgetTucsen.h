...
#ifndef DOCKWIDGETTucsen_H
#define DOCKWIDGETTucsen_H
...
#include "ui_dockWidgetTucsen.h"

class DockWidgetTucsen : public ito::AbstractAddInDockWidget
{
    Q_OBJECT

    public:
        DockWidgetTucsen(ito::AddInDataIO* grabber);
        ~DockWidgetTucsen() {};

    private:
        Ui::DockWidgetTucsen ui;
        bool m_inEditing;
        bool m_firstRun;
