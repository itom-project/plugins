...
//----------------------------------------------------------------------------------------------------------------------------------
DialogNerianSceneScanPro::DialogNerianSceneScanPro(ito::AddInBase *grabber) :
...
//----------------------------------------------------------------------------------------------------------------------------------
void DialogNerianSceneScanPro::parametersChanged(QMap<QString, ito::Param> params)
{
...
//----------------------------------------------------------------------------------------------------------------------------------
ito::RetVal DialogNerianSceneScanPro::applyParameters()
{
...
//---------------------------------------------------------------------------------------------------------------------
void DialogNerianSceneScanPro::on_buttonBox_clicked(QAbstractButton* btn)
{
...
//---------------------------------------------------------------------------------------------------------------------
void DialogNerianSceneScanPro::enableDialog(bool enabled)
{
