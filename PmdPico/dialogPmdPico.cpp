...
//----------------------------------------------------------------------------------------------------------------------------------
DialogPmdPico::DialogPmdPico(ito::AddInBase *grabber) :
...
//----------------------------------------------------------------------------------------------------------------------------------
void DialogPmdPico::parametersChanged(QMap<QString, ito::Param> params)
{
...
//----------------------------------------------------------------------------------------------------------------------------------
ito::RetVal DialogPmdPico::applyParameters()
{
...
//---------------------------------------------------------------------------------------------------------------------
void DialogPmdPico::on_buttonBox_clicked(QAbstractButton* btn)
{
    ito::RetVal retValue(ito::retOk);
...
//---------------------------------------------------------------------------------------------------------------------
void DialogPmdPico::enableDialog(bool enabled)
{
    //e.g.
