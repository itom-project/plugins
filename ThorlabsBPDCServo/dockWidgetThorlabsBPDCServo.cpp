...
//-------------------------------------------------------------------------------------------------------------------------------------------------
DockWidgetThorlabsBPDCServo::DockWidgetThorlabsBPDCServo(ito::AddInActuator* actuator) :
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
void DockWidgetThorlabsBPDCServo::parametersChanged(QMap<QString, ito::Param> params)
{
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
void DockWidgetThorlabsBPDCServo::enableWidget(bool enabled)
{
    ui.motorAxisController->setEnabled(enabled);
}

//-------------------------------------------------------------------------------------------------------------------------------------------------
void DockWidgetThorlabsBPDCServo::dockWidgetVisibilityChanged(bool visible)
{
    if (visible)
    {
