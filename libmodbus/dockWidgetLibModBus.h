...
#include "ui_dockWidgetLibModBus.h"
...
class DockWidgetLibModBus : public QWidget
{
    Q_OBJECT

    public:
        DockWidgetLibModBus(QMap<QString, ito::Param> params, int uniqueID);
        ~DockWidgetLibModBus() {};

    private:
        Ui::DockWidgetLibModBus ui;
