...
ito::RetVal IDSuEye::synchronizeCameraSettings(int what /*= sAll*/)
{
    ...
    if (what & sTriggerMode)
    {
        ...
        case IS_SET_TRIGGER_OFF:
            it->setVal<char*>(tr("off").toLatin1().data());
            break;
        case IS_SET_TRIGGER_SOFTWARE:
            it->setVal<char*>(tr("software").toLatin1().data());
            break;
        case IS_SET_TRIGGER_HI_LO:
            it->setVal<char*>(tr("hi_lo").toLatin1().data()); 
            break;
        case IS_SET_TRIGGER_LO_HI:
            it->setVal<char*>(tr("lo_hi").toLatin1().data()); 
            break;
        case IS_SET_TRIGGER_PRE_HI_LO:
            it->setVal<char*>(tr("pre_hi_lo").toLatin1().data()); 
            break;
        case IS_SET_TRIGGER_PRE_LO_HI:
            it->setVal<char*>(tr("pre_lo_hi").toLatin1().data()); 
            break;
        default:
    ...
    if (what & sBppAndColorMode)
    {
        ...
        if (m_sensorInfo.nColorMode == IS_COLORMODE_MONOCHROME)
        {
            ...
            m_colouredOutput = false;
            m_params["color_mode"].setVal<char*>(tr("gray").toLatin1().data());
        ...
        else //color
        {
            ...
            {
                m_params["color_mode"].setVal<char*>(tr("color").toLatin1().data());
                m_bitspixel = 32;
...
ito::RetVal IDSuEye::loadSensorInfo()
{
    ...
    if (!retVal.containsError())
    {
        ...
        {
        case IS_SENSOR_UI141X_M: it->setVal<char*>(tr("UI141X_M, VGA rolling shutter, monochrome").toLatin1().data());
            break;
        case IS_SENSOR_UI141X_C:
            it->setVal<char*>(tr("UI141X_C, VGA rolling shutter, color").toLatin1().data());
            break;
        case IS_SENSOR_UI144X_M:
            it->setVal<char*>(tr("UI144X_M, SXGA rolling shutter, monochrome").toLatin1().data());
            break;
        case IS_SENSOR_UI144X_C:
            it->setVal<char*>(tr("UI144X_C, SXGA rolling shutter, SXGA color").toLatin1().data());
            break;
            
            case IS_SENSOR_UI154X_M:
            it->setVal<char*>(tr("UI154X_M, SXGA rolling shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI154X_C:
            it->setVal<char*>(tr("UI154X_C, SXGA rolling shutter, color").toLatin1().data());
            break;
            case IS_SENSOR_UI145X_C:
            it->setVal<char*>(tr("UI145X_C, UXGA rolling shutter, color").toLatin1().data());
            break;
            
            case IS_SENSOR_UI146X_C:
            it->setVal<char*>(tr("UI146X_C, QXGA rolling shutter, color").toLatin1().data());
            break;
            case IS_SENSOR_UI148X_M:
            it->setVal<char*>(tr("UI148X_M, 5MP rolling shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI148X_C:
            it->setVal<char*>(tr("UI148X_C, 5MP rolling shutter, color").toLatin1().data());
            break;
            
            case IS_SENSOR_UI121X_M:
            it->setVal<char*>(tr("UI121X_M, VGA global shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI121X_C:
            it->setVal<char*>(tr("UI121X_C, VGA global shutter, VGA color").toLatin1().data());
            break;
            case IS_SENSOR_UI122X_M:
            it->setVal<char*>(tr("UI122X_M, WVGA global shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI122X_C:
            it->setVal<char*>(tr("UI122X_C, WVGA global shutter, color").toLatin1().data());
            break;
            
            case IS_SENSOR_UI164X_C:
            it->setVal<char*>(tr("UI164X_C, SXGA rolling shutter, color").toLatin1().data());
            break;
            
            case IS_SENSOR_UI155X_C:
            it->setVal<char*>(tr("UI155X_C, UXGA rolling shutter, color").toLatin1().data());
            break;
            
            case IS_SENSOR_UI1223_M:
            it->setVal<char*>(tr("UI1223_M, WVGA global shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1223_C:
            it->setVal<char*>(tr("UI1223_C, WVGA global shutter, color").toLatin1().data());
            break;
            
            case IS_SENSOR_UI149X_M:
            it->setVal<char*>(tr("UI149X_M, 10MP rolling shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI149X_C:
            it->setVal<char*>(tr("UI149X_C, 10MP rolling shutter, color").toLatin1().data());
            break;
            
            case IS_SENSOR_UI1225_M:
            it->setVal<char*>(
                tr("UI1225_M, WVGA global shutter, monochrome, LE model").toLatin1().data());
            break;
            case IS_SENSOR_UI1225_C:
            it->setVal<char*>(
                tr("UI1225_C, WVGA global shutter, color, LE model").toLatin1().data());
            break;
            
            case IS_SENSOR_UI1645_C:
            it->setVal<char*>(
                tr("UI1645_C, SXGA rolling shutter, color, LE model").toLatin1().data());
            break;
            case IS_SENSOR_UI1555_C:
            it->setVal<char*>(
                tr("UI1555_C, UXGA rolling shutter, color, LE model").toLatin1().data());
            break;
            case IS_SENSOR_UI1545_M:
            it->setVal<char*>(
                tr("UI1545_M, SXGA rolling shutter, monochrome, LE model").toLatin1().data());
            break;
            case IS_SENSOR_UI1545_C:
            it->setVal<char*>(
                tr("UI1545_C, SXGA rolling shutter, color, LE model").toLatin1().data());
            break;
            case IS_SENSOR_UI1455_C:
            it->setVal<char*>(
                tr("UI1455_C, UXGA rolling shutter, color, LE model").toLatin1().data());
            break;
            case IS_SENSOR_UI1465_C:
            it->setVal<char*>(
                tr("UI1465_C, QXGA rolling shutter, color, LE model").toLatin1().data());
            break;
            case IS_SENSOR_UI1485_M:
            it->setVal<char*>(
                tr("UI1485_M, 5MP rolling shutter, monochrome, LE model").toLatin1().data());
            break;
            case IS_SENSOR_UI1485_C:
            it->setVal<char*>(
                tr("UI1485_C, 5MP rolling shutter, color, LE model").toLatin1().data());
            break;
            case IS_SENSOR_UI1495_M:
            it->setVal<char*>(
                tr("UI1495_M, 10MP rolling shutter, monochrome, LE model").toLatin1().data());
            break;
            case IS_SENSOR_UI1495_C:
            it->setVal<char*>(
                tr("UI1495_C, 10MP rolling shutter, color, LE model").toLatin1().data());
            break;
            
            case IS_SENSOR_UI112X_M:
            it->setVal<char*>(tr("UI112X_M, 0768x576, HDR sensor, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI112X_C:
            it->setVal<char*>(tr("UI112X_C, 0768x576, HDR sensor, color").toLatin1().data());
            break;
            
            case IS_SENSOR_UI1008_M:
            it->setVal<char*>(tr("UI1008_M").toLatin1().data());
            break;
            case IS_SENSOR_UI1008_C:
            it->setVal<char*>(tr("UI1008_C").toLatin1().data());
            break;

#if defined IS_SENSOR_UIF005_M //SDK < 4.81
            case IS_SENSOR_UIF005_M:
            it->setVal<char*>(tr("UIF005_M").toLatin1().data());
            break;
            case IS_SENSOR_UIF005_C:
            it->setVal<char*>(tr("UIF005_C").toLatin1().data());
            break;
#endif

            case IS_SENSOR_UI1005_M:
            it->setVal<char*>(tr("UI1005_M").toLatin1().data());
            break;
            case IS_SENSOR_UI1005_C:
            it->setVal<char*>(tr("UI1005_C").toLatin1().data());
            break;
           
#if defined IS_SENSOR_UI1007_M //SDK >= 4.95
            case IS_SENSOR_UI1007_M:
            it->setVal<char*>(tr("5MP rolling shutter, color").toLatin1().data());
            break;
            case IS_SENSOR_UI1007_C:
            it->setVal<char*>(tr("5MP rolling shutter, color").toLatin1().data());
            break;
#endif

            case IS_SENSOR_UI1240_M:
            it->setVal<char*>(tr("UI1240_M, SXGA global shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1240_C:
            it->setVal<char*>(tr("UI1240_C, SXGA global shutter, color").toLatin1().data());
            break;
            case IS_SENSOR_UI1240_NIR:
            it->setVal<char*>(tr("UI1240_NIR, SXGA global shutter, NIR").toLatin1().data());
            break;
            
            case IS_SENSOR_UI1240LE_M:
            it->setVal<char*>(
                tr("UI1240LE_M, SXGA global shutter, monochrome, single board").toLatin1().data());
            break;
            case IS_SENSOR_UI1240LE_C:
            it->setVal<char*>(
                tr("UI1240LE_C, SXGA global shutter, color, single board").toLatin1().data());
            break;
            case IS_SENSOR_UI1240LE_NIR:
            it->setVal<char*>(
                tr("UI1240LE_NIR, SXGA global shutter, NIR, single board").toLatin1().data());
            break;
            
            case IS_SENSOR_UI1240ML_M:
            it->setVal<char*>(
                tr("UI1240ML_M, SXGA global shutter, monochrome, single board").toLatin1().data());
            break;
            case IS_SENSOR_UI1240ML_C:
            it->setVal<char*>(
                tr("UI1240ML_C, SXGA global shutter, color, single board").toLatin1().data());
            break;
            case IS_SENSOR_UI1240ML_NIR:
            it->setVal<char*>(
                tr("UI1240ML_NIR, SXGA global shutter, NIR, single board").toLatin1().data());
            break;
            
            case IS_SENSOR_UI1243_M_SMI:
            it->setVal<char*>(tr("UI1243_M_SMI").toLatin1().data());
            break;
            case IS_SENSOR_UI1243_C_SMI:
            it->setVal<char*>(tr("UI1243_C_SMI").toLatin1().data());
            break;
            
            case IS_SENSOR_UI1543_M:
            it->setVal<char*>(
                tr("UI1543_M, SXGA rolling shutter, monochrome, single board").toLatin1().data());
            break;
            case IS_SENSOR_UI1543_C:
            it->setVal<char*>(
                tr("UI1543_C, SXGA rolling shutter, color, single board").toLatin1().data());
            break;
            
            case IS_SENSOR_UI1544_M:
            it->setVal<char*>(
                tr("UI1544_M, SXGA rolling shutter, monochrome, single board").toLatin1().data());
            break;
            case IS_SENSOR_UI1544_C:
            it->setVal<char*>(
                tr("UI1544_C, SXGA rolling shutter, color, single board").toLatin1().data());
            break;
            case IS_SENSOR_UI1543_M_WO:
            it->setVal<char*>(tr("UI1543_M_WO, SXGA rolling shutter, monochrome, single board")
                                  .toLatin1()
                                  .data());
            break;
            case IS_SENSOR_UI1543_C_WO:
            it->setVal<char*>(
                tr("UI1543_C_WO, SXGA rolling shutter, color, single board").toLatin1().data());
            break;
            case IS_SENSOR_UI1453_C:
            it->setVal<char*>(
                tr("UI1453_C, UXGA rolling shutter, color, single board").toLatin1().data());
            break;
            case IS_SENSOR_UI1463_C:
            it->setVal<char*>(
                tr("UI1463_C, QXGA rolling shutter, color, single board").toLatin1().data());
            break;
            case IS_SENSOR_UI1483_M:
            it->setVal<char*>(
                tr("UI1483_M, QSXG rolling shutter, monochrome, single board").toLatin1().data());
            break;
            case IS_SENSOR_UI1483_C:
            it->setVal<char*>(
                tr("UI1483_C, QSXG rolling shutter, color, single board").toLatin1().data());
            break;
            case IS_SENSOR_UI1493_M:
            it->setVal<char*>(
                tr("UI1493_M, 10Mp rolling shutter, monochrome, single board").toLatin1().data());
            break;
            case IS_SENSOR_UI1493_C:
            it->setVal<char*>(
                tr("UI1493_C, 10MP rolling shutter, color, single board").toLatin1().data());
            break;
            
            case IS_SENSOR_UI1463_M_WO:
            it->setVal<char*>(tr("UI1463_M_WO, QXGA rolling shutter, monochrome, single board")
                                  .toLatin1()
                                  .data());
            break;
            case IS_SENSOR_UI1463_C_WO:
            it->setVal<char*>(
                tr("UI1463_C_WO, QXGA rolling shutter, color, single board").toLatin1().data());
            break;
            
            case IS_SENSOR_UI1553_C_WN:
            it->setVal<char*>(
                tr("UI1553_C_WN, UXGA rolling shutter, color, single board").toLatin1().data());
            break;
            case IS_SENSOR_UI1483_M_WO:
            it->setVal<char*>(tr("UI1483_M_WO, QSXGA rolling shutter, monochrome, single board")
                                  .toLatin1()
                                  .data());
            break;
            case IS_SENSOR_UI1483_C_WO:
            it->setVal<char*>(
                tr("UI1483_C_WO, QSXGA rolling shutter, color, single board").toLatin1().data());
            break;
            
            case IS_SENSOR_UI1580_M:
            it->setVal<char*>(tr("UI1580_M, 5MP rolling shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1580_C:
            it->setVal<char*>(tr("UI1580_C, 5MP rolling shutter, color").toLatin1().data());
            break;
            case IS_SENSOR_UI1580LE_M:
            it->setVal<char*>(
                tr("UI1580LE_M, 5MP rolling shutter, monochrome, single board").toLatin1().data());
            break;
            case IS_SENSOR_UI1580LE_C:
            it->setVal<char*>(
                tr("UI1580LE_C, 5MP rolling shutter, color, single board").toLatin1().data());
            break;
            
            case IS_SENSOR_UI1360M:
            it->setVal<char*>(tr("UI1360M, 2.2MP global shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1360C:
            it->setVal<char*>(tr("UI1360C, 2.2MP global shutter, color").toLatin1().data());
            break;
            case IS_SENSOR_UI1360NIR:
            it->setVal<char*>(tr("UI1360NIR, 2.2MP global shutter, NIR").toLatin1().data());
            break;
            
            case IS_SENSOR_UI1370M:
            it->setVal<char*>(tr("UI1370M, 4.2MP global shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1370C:
            it->setVal<char*>(tr("UI1370C, 4.2MP global shutter, color").toLatin1().data());
            break;
            case IS_SENSOR_UI1370NIR:
            it->setVal<char*>(tr("UI1370NIR, 4.2MP global shutter, NIR").toLatin1().data());
            break;
            
            case IS_SENSOR_UI1250_M:
            it->setVal<char*>(tr("UI1250_M, 2MP global shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1250_C:
            it->setVal<char*>(tr("UI1250_C, 2MP global shutter, color").toLatin1().data());
            break;
            case IS_SENSOR_UI1250_NIR:
            it->setVal<char*>(tr("UI1250_NIR, 2MP global shutter, NIR").toLatin1().data());
            break;
            
            case IS_SENSOR_UI1250LE_M:
            it->setVal<char*>(
                tr("UI1250LE_M, 2MP global shutter, monochrome, single board").toLatin1().data());
            break;
            case IS_SENSOR_UI1250LE_C:
            it->setVal<char*>(
                tr("UI1250LE_C, 2MP global shutter, color, single board").toLatin1().data());
            break;
            case IS_SENSOR_UI1250LE_NIR:
            it->setVal<char*>(
                tr("UI1250LE_NIR, 2MP global shutter, NIR, single board").toLatin1().data());
            break;
            
            case IS_SENSOR_UI1250ML_M:
            it->setVal<char*>(
                tr("UI1250ML_M, 2MP global shutter, monochrome, single board").toLatin1().data());
            break;
            case IS_SENSOR_UI1250ML_C:
            it->setVal<char*>(
                tr("UI1250ML_C, 2MP global shutter, color, single board").toLatin1().data());
            break;
            case IS_SENSOR_UI1250ML_NIR:
            it->setVal<char*>(tr(", 2MP global shutter, NIR, single board").toLatin1().data());
            break;
            
            case IS_SENSOR_UI1493_M_AR:
            it->setVal<char*>(tr("UI1493_M_AR").toLatin1().data());
            break;
            case IS_SENSOR_UI1493_C_AR:
            it->setVal<char*>(tr("UI1493_C_AR").toLatin1().data());
            break;

#if defined IS_SENSOR_UI1060_M //>= SDK 4.61
            case IS_SENSOR_UI1060_M:
            it->setVal<char*>(tr("UI1060_M, 2.3MP global shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1060_C:
            it->setVal<char*>(tr("UI1060_C, 2.3MP global shutter, color").toLatin1().data());
            break;
            case IS_SENSOR_UI1013XC:
            it->setVal<char*>(tr("UI1013XC, 13MP, color").toLatin1().data());
            break;
#endif

#if defined IS_SENSOR_UI1140M  //>= SDK 4.80         
			case IS_SENSOR_UI1140M:
            it->setVal<char*>(tr("UI1140M, 1.3MP global shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1140C:
            it->setVal<char*>(tr("UI1140C, 1.3MP global shutter, color").toLatin1().data());
            break;
            case IS_SENSOR_UI1140NIR:
            it->setVal<char*>(tr("UI1140NIR, 1.3MP global shutter, NIR").toLatin1().data());
            break;
			
            case IS_SENSOR_UI1590M:
            it->setVal<char*>(tr("UI1590M, 18MP rolling shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1590C:
            it->setVal<char*>(tr("UI1590C, 18MP rolling shutter, color").toLatin1().data());
            break;
			
            case IS_SENSOR_UI1260_M:
            it->setVal<char*>(tr("UI1260_M, 2.3MP global shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1260_C:
            it->setVal<char*>(tr("UI1260_C, 2.3MP global shutter, color").toLatin1().data());
            break;
			
            case IS_SENSOR_UI1130_M:
            it->setVal<char*>(tr("UI1130_M, SVGA global shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1130_C:
            it->setVal<char*>(tr("UI1130_C, SVGA global shutter, color").toLatin1().data());
            break;
			
            case IS_SENSOR_UI1160_M:
            it->setVal<char*>(tr("UI1160_M, 2.3MP global shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1160_C:
            it->setVal<char*>(tr("UI1160_C, 2.3MP global shutter, color").toLatin1().data());
            break;
			
            case IS_SENSOR_UI1180_M:
            it->setVal<char*>(tr("UI1180_M, 5.3MP global shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1180_C:
            it->setVal<char*>(tr("UI1180_C, 5.3MP global shutter, color").toLatin1().data());
            break;
			
            case IS_SENSOR_UI1080_M:
            it->setVal<char*>(tr("UI1080_M, 5MP global shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1080_C:
            it->setVal<char*>(tr("UI1080_C, 5MP global shutter, color").toLatin1().data());
            break;
#endif

#if defined IS_SENSOR_UI1280_M //>= SDK 4.81
            case IS_SENSOR_UI1280_M:
            it->setVal<char*>(tr("UI1280_M, 5MP global shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1280_C:
            it->setVal<char*>(tr("UI1280_C, 5MP global shutter, color").toLatin1().data());
            break;
			
            case IS_SENSOR_UI1860_M:
            it->setVal<char*>(tr("UI1860_M, 2MP rolling shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1860_C:
            it->setVal<char*>(tr("UI1860_C, 2MP rolling shutter, color").toLatin1().data());
            break;
			
            case IS_SENSOR_UI1880_M:
            it->setVal<char*>(tr("UI1880_M, 6MP rolling shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1880_C:
            it->setVal<char*>(tr("UI1880_C, 6MP rolling shutter, color").toLatin1().data());
            break;
			
            case IS_SENSOR_UI1270_M:
            it->setVal<char*>(tr("UI1270_M, 3.2MP global shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1270_C:
            it->setVal<char*>(tr("UI1270_C, 3.2MP global shutter, color").toLatin1().data());
            break;
			
            case IS_SENSOR_UI1070_M:
            it->setVal<char*>(tr("UI1070_M, 3.2MP global shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1070_C:
            it->setVal<char*>(tr("UI1070_C, 3.2MP global shutter, color").toLatin1().data());
            break;
			
            case IS_SENSOR_UI1130LE_M:
            it->setVal<char*>(tr("UI1130LE_M, SVGA global shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1130LE_C:
            it->setVal<char*>(tr("UI1130LE_C, SVGA global shutter, color").toLatin1().data());
            break;
#endif

#if defined IS_SENSOR_UI1290_M //>= SDK 4.95
            case IS_SENSOR_UI1290_M:
            it->setVal<char*>(tr("8.9MP global shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1290_C:
            it->setVal<char*>(tr("8.9MP global shutter, color").toLatin1().data());
            break;

            case IS_SENSOR_UI1090_M:
            it->setVal<char*>(tr("8.9MP global shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1090_C:
            it->setVal<char*>(tr("8.9MP global shutter, color").toLatin1().data());
            break;

            case IS_SENSOR_UI1000_M:
            it->setVal<char*>(tr("12.3MP global shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1000_C:
            it->setVal<char*>(tr("12.3MP global shutter, color").toLatin1().data());
            break;

            case IS_SENSOR_UI1200_M:
            it->setVal<char*>(tr("12.3MP global shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1200_C:
            it->setVal<char*>(tr("12.3MP global shutter, color").toLatin1().data());
            break;

            case IS_SENSOR_UI1040_M:
            it->setVal<char*>(tr("1.6MP global shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1040_C:
            it->setVal<char*>(tr("1.6MP global shutter, color").toLatin1().data());
            break;

            case IS_SENSOR_UI1180_M_S2:
            it->setVal<char*>(tr("5.3MP global shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1180_C_S2:
            it->setVal<char*>(tr("5.3MP global shutter, color").toLatin1().data());
            break;

            case IS_SENSOR_UI1160_M_S2:
            it->setVal<char*>(tr("2.3MP global shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1160_C_S2:
            it->setVal<char*>(tr("2.3MP global shutter, color").toLatin1().data());
            break;

            case IS_SENSOR_UI1020_M:
            it->setVal<char*>(tr("0.4MP global shutter, monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI1020_C:
            it->setVal<char*>(tr("0.4MP global shutter, color").toLatin1().data());
            break;
#endif

            case IS_SENSOR_UI223X_M:
            it->setVal<char*>(tr("UI223X_M, Sony CCD sensor - XGA monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI223X_C:
            it->setVal<char*>(tr("UI223X_C, Sony CCD sensor - XGA color").toLatin1().data());
            break;
            case IS_SENSOR_UI241X_M:
            it->setVal<char*>(tr("UI241X_M, Sony CCD sensor - VGA monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI241X_C:
            it->setVal<char*>(tr("UI241X_C, Sony CCD sensor - VGA color").toLatin1().data());
            break;
            case IS_SENSOR_UI234X_M:
            it->setVal<char*>(tr("UI234X_M, Sony CCD sensor - SXGA monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI234X_C:
            it->setVal<char*>(tr("UI234X_C, Sony CCD sensor - SXGA color").toLatin1().data());
            break;
            case IS_SENSOR_UI221X_M:
            it->setVal<char*>(tr("UI221X_M, Sony CCD sensor - VGA monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI221X_C:
            it->setVal<char*>(tr("UI221X_C, Sony CCD sensor - VGA color").toLatin1().data());
            break;
            case IS_SENSOR_UI231X_M:
            it->setVal<char*>(tr("UI231X_M, Sony CCD sensor - VGA monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI231X_C:
            it->setVal<char*>(tr("UI231X_C, Sony CCD sensor - VGA color").toLatin1().data());
            break;
            case IS_SENSOR_UI222X_M:
            it->setVal<char*>(
                tr("UI222X_M, Sony CCD sensor - CCIR / PAL monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI222X_C:
            it->setVal<char*>(tr("UI222X_C, Sony CCD sensor - CCIR / PAL color").toLatin1().data());
            break;
            case IS_SENSOR_UI224X_M:
            it->setVal<char*>(tr("UI224X_M, Sony CCD sensor - SXGA monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI224X_C:
            it->setVal<char*>(tr("UI224X_C, Sony CCD sensor - SXGA color").toLatin1().data());
            break;
            case IS_SENSOR_UI225X_M:
            it->setVal<char*>(tr("UI225X_M, Sony CCD sensor - UXGA monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI225X_C:
            it->setVal<char*>(tr("UI225X_C, Sony CCD sensor - UXGA color").toLatin1().data());
            break;
            case IS_SENSOR_UI214X_M:
            it->setVal<char*>(tr("UI214X_M, Sony CCD sensor - SXGA monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI214X_C:
            it->setVal<char*>(tr("UI214X_C, Sony CCD sensor - SXGA color").toLatin1().data());
            break;
            case IS_SENSOR_UI228X_M:
            it->setVal<char*>(tr("UI228X_M, Sony CCD sensor - QXGA monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI228X_C:
            it->setVal<char*>(tr("UI228X_C, Sony CCD sensor - QXGA color").toLatin1().data());
            break;
            case IS_SENSOR_UI251X_M:
            it->setVal<char*>(
                tr("UI251X_M or UI241X_M_R2, Sony CCD sensor - VGA monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI251X_C:
            it->setVal<char*>(
                tr("UI251X_C or UI241X_C_R2, Sony CCD sensor - VGA color").toLatin1().data());
            break;
            case IS_SENSOR_UI2130_M:
            it->setVal<char*>(tr("UI2130_M, Sony CCD sensor - WXGA monochrome").toLatin1().data());
            break;
            case IS_SENSOR_UI2130_C:
            it->setVal<char*>(tr("UI2130_C, Sony CCD sensor - WXGA color").toLatin1().data());
            break;

            default:
            it->setVal<char*>(tr("unknown sensor type").toLatin1().data());
            break;
        }
    }
