...
* float32 or float64 are saved as gray-values (8bit or if supported as 16bit) or according to the defined color palette. Therefore the values must be between 0.0 and 1.0.\n\
    ...
    ItomSharedSemaphore* /*waitCond*/)
{
    ...
    filter = new FilterDef(
        DataObjectIO::saveDataObject, DataObjectIO::saveDataObjectParams, saveDataObjectDoc);
    m_filterList.insert("saveDataObject", filter);

    filter = new FilterDef(
        DataObjectIO::loadDataObject, DataObjectIO::loadDataObjectParams, loadDataObjectDoc);
    m_filterList.insert("loadDataObject", filter);

    filter = new FilterDef(
        DataObjectIO::loadImage,
        DataObjectIO::loadImageParams,
        loadImageDoc,
        ito::AddInAlgo::catDiskIO,
        ito::AddInAlgo::iReadDataObject,
        tr("Images (*.pgm *.pbm *.ppm *.sr *.ras *.bmp *.dib *.png *.tif *.tiff *.jpg *.jpeg *.jp2 "
           "*.gif *.xbm *.xpm)"));
    m_filterList.insert("loadAnyImage", filter);

    filter = new FilterDef(
        DataObjectIO::saveNistSDF,
        DataObjectIO::saveNistSDFParams,
        saveNistSDFDoc,
        ito::AddInAlgo::catDiskIO,
        ito::AddInAlgo::iWriteDataObject,
        tr("ASCII Surface Data File (*.sdf)"));
    m_filterList.insert("saveSDF", filter);

    filter = new FilterDef(
        DataObjectIO::loadNistSDF,
        DataObjectIO::loadNistSDFParams,
        loadNistSDFDoc,
        ito::AddInAlgo::catDiskIO,
        ito::AddInAlgo::iReadDataObject,
        tr("ASCII or binary Surface Data File (*.sdf)"));
    m_filterList.insert("loadSDF", filter);

    filter = new FilterDef(
        DataObjectIO::saveTiff,
        DataObjectIO::saveTiffParams,
        saveTiffDoc,
        ito::AddInAlgo::catDiskIO,
        ito::AddInAlgo::iWriteDataObject,
        tr("Images (*.tif *.tiff)"));
    ...
    filter = new FilterDef(
        DataObjectIO::saveJPG,
        DataObjectIO::saveJPGParams,
        saveJPGDoc,
        ito::AddInAlgo::catDiskIO,
        ito::AddInAlgo::iWriteDataObject,
        tr("Images (*.jpg *.jpeg *.jp2)"));
    m_filterList.insert("saveJPG", filter);

    filter = new FilterDef(
        DataObjectIO::savePNG,
        DataObjectIO::savePNGParams,
        savePNGDoc,
        ito::AddInAlgo::catDiskIO,
        ito::AddInAlgo::iWriteDataObject,
        tr("Images (*.png)"));
    ...
    filter = new FilterDef(
        DataObjectIO::saveXPM,
        DataObjectIO::saveXPMParams,
        saveXPMDoc,
        ito::AddInAlgo::catDiskIO,
        ito::AddInAlgo::iWriteDataObject,
        tr("Images (*.xpm *.xbm)"));
    ...
    filter = new FilterDef(
        DataObjectIO::saveBMP,
        DataObjectIO::saveBMPParams,
        saveBMPDoc,
        ito::AddInAlgo::catDiskIO,
        ito::AddInAlgo::iWriteDataObject,
        tr("Images (*.bmp *.dib)"));
    ...
    filter = new FilterDef(
        DataObjectIO::saveRAS,
        DataObjectIO::saveRASParams,
        saveRASDoc,
        ito::AddInAlgo::catDiskIO,
        ito::AddInAlgo::iWriteDataObject,
        tr("Images (*.sr *.ras)"));
    ...
    filter = new FilterDef(
        DataObjectIO::savePPM,
        DataObjectIO::savePPMParams,
        savePPMDoc,
        ito::AddInAlgo::catDiskIO,
        ito::AddInAlgo::iWriteDataObject,
        tr("Images (*.ppm)"));
    ...
    filter = new FilterDef(
        DataObjectIO::savePGM,
        DataObjectIO::savePGMParams,
        savePGMDoc,
        ito::AddInAlgo::catDiskIO,
        ito::AddInAlgo::iWriteDataObject,
        tr("Images (*.pgm *.pbm)"));
    ...
    filter = new FilterDef(
        DataObjectIO::saveItomIDO,
        DataObjectIO::saveItomIDOParams,
        saveItomIDODoc,
        ito::AddInAlgo::catDiskIO,
        ito::AddInAlgo::iWriteDataObject,
        tr("Raw-XML (*.ido *.idh)"));
    ...
    filter = new FilterDef(
        DataObjectIO::saveDataToTxt,
        DataObjectIO::saveDataToTxtParams,
        saveDataToTxtDoc,
        ito::AddInAlgo::catDiskIO,
        ito::AddInAlgo::iWriteDataObject,
        tr("ASCII Data (*.txt *.csv *.tsv)"));
    m_filterList.insert("saveTXT", filter);

    filter = new FilterDef(
        DataObjectIO::loadItomIDO,
        DataObjectIO::loadItomIDOParams,
        loadItomIDODoc,
        ito::AddInAlgo::catDiskIO,
        ito::AddInAlgo::iReadDataObject,
        tr("Raw-XML (*.ido *.idh)"));
    ...
    filter = new FilterDef(
        DataObjectIO::loadDataFromTxt,
        DataObjectIO::loadDataFromTxtParams,
        loadDataFromTxtDoc,
        ito::AddInAlgo::catDiskIO,
        ito::AddInAlgo::iReadDataObject,
        tr("ASCII Data (*.txt *.csv *.tsv)"));
    ...
    filter = new FilterDef(
        DataObjectIO::loadFrt,
        DataObjectIO::loadFrtParams,
        loadFrtDoc,
        ito::AddInAlgo::catDiskIO,
        ito::AddInAlgo::iReadDataObject,
        tr("MicroProf FRT (*.frt)"));
    m_filterList.insert("loadFRT", filter);

    filter = new FilterDef(
        DataObjectIO::loadNanoscopeIII,
        DataObjectIO::loadNanoscopeIIIParams,
        loadNanoscopeIIIDoc,
        ito::AddInAlgo::catDiskIO,
        ito::AddInAlgo::iReadDataObject,
        tr("Veeco Nanoscope III (*.001 *.002 *.003 *.004)"));
    m_filterList.insert("loadNanoscopeIII", filter);

    filter = new FilterDef(
        DataObjectIO::loadAvantesRaw,
        DataObjectIO::loadAvantesRawParams,
        loadAvantesRawDoc,
        ito::AddInAlgo::catDiskIO,
        ito::AddInAlgo::iReadDataObject,
        tr("Avantes (*.raw8 *.rwd8 *.abs8 *.trm8 *.irr8 *.rfl8 *.rir8)"));
    m_filterList.insert("loadAvantesRaw", filter);

    filter = new FilterDef(
        DataObjectIO::loadZygoMetroPro,
        DataObjectIO::loadZygoMetroProParams,
        loadZygoMetroProDoc,
        ito::AddInAlgo::catDiskIO,
        ito::AddInAlgo::iReadDataObject,
        tr("Zygo MetroPro Data File (*.dat)"));
    m_filterList.insert("loadZygoMetroPro", filter);

    filter = new FilterDef(
        DataObjectIO::loadKeyenceVK4,
        DataObjectIO::loadKeyenceVK4Params,
        loadKeyenceVK4Doc,
        ito::AddInAlgo::catDiskIO,
        ito::AddInAlgo::iReadDataObject,
        tr("Keyence vk4 profilometry images (*.vk4)"));
    m_filterList.insert("loadKeyenceVk4", filter);

    filter = new FilterDef(
        DataObjectIO::savePtbPR,
        DataObjectIO::savePtbPRParams,
        savePtbPRDoc,
        ito::AddInAlgo::catDiskIO,
        ito::AddInAlgo::iWriteDataObject,
        tr("PR Line Profile (*.pr)"));
...
//----------------------------------------------------------------------------------------------------------------------------------
/*static*/ const QString DataObjectIO::saveDataObjectDoc = QObject::tr(
    "saves 1D and 2D dataObject to image formats via QImage (for saving images it is recommended "
    "to use the specific saveABC (savePNG, saveGIF, saveBMP...) commands).");
 ...
 *
 *   This Function interacts with itom Python application, constructs plugin functionality, creates
 * necessary parameters (eg. Mandatory and Optional parameters) and their specifications as required
 * for converting DataObject into Image and save it into Hard drive.
 */
ito::RetVal DataObjectIO::saveDataObjectParams(
    QVector<ito::Param>* paramsMand, QVector<ito::Param>* paramsOpt, QVector<ito::Param>* paramsOut)
{
    ...
    if (!retval.containsError())
    {
        ito::Param param = ito::Param(
            ...
            NULL,
            tr("2D-DataObject of anytype or 3-planes DataObject of uint8").toLatin1().data());
        paramsMand->append(param);
        param = ito::Param(
            "filename",
            ito::ParamBase::String | ito::ParamBase::In,
            "",
            tr("Destination filename").toLatin1().data());
        paramsMand->append(param);
        param = ito::Param(
            "format",
            ito::ParamBase::String | ito::ParamBase::In,
            "",
            tr("Format of the Image according to QImage: ['QImage::Format_Mono', "
        ...
        param = ito::Param(
            ...
            2,
            1,
            tr("Toggle bit-scaling, 0 = off, 1 = autoscale (default), 2 = userdefined ranges")
                .toLatin1()
                .data());
        paramsMand->append(param);
        param = ito::Param(
            ...
            0.0,
            tr("Lowest limit. Will become 0").toLatin1().data());
        ...
        param = ito::Param(
            ...
            std::numeric_limits<double>::max(),
            1.0,
            tr("Lowest limit. Will become max<bitdepth>").toLatin1().data());
        paramsOpt->append(param);
        param = ito::Param(
            "colorFormat",
            ito::ParamBase::String | ito::ParamBase::In,
            "",
            tr("When DataObject of type float32, their format should be -->Gray<-- or -->RGB<--")
                .toLatin1()
                .data());
        paramsOpt->append(param);
    }
 ...
 *    @param [out] outVals   optional output parameters
 *
 *   This Function accepts parameters from itom Python application according to specification
 * provided by "saveDataObjectParams" function. It converts passed DataObject into corresponding
 * Image as per given Image Format and stores it to specific location provided on Hard drive.
 */
ito::RetVal DataObjectIO::saveDataObject(
    QVector<ito::ParamBase>* paramsMand,
    QVector<ito::ParamBase>* paramsOpt,
    QVector<ito::ParamBase>* /*paramsOut*/)
{
    ...
    if (toggle == 2 &&
        (fabs(lowLimit - highLimit) < std::numeric_limits<double>::epsilon() ||
         lowLimit > highLimit))
    {
        ret += ito::RetVal(
            ito::retError,
            0,
            tr("Save to image failed: lowLimit must be unequal to highLimit and smaller than "
               "highLimit")
                .toLatin1()
                .data());
    }
    ...
    {
        if (dObj->getDims() == 2 ||
            (dObj->getDims() > 2 && dObj->calcNumMats() == 1)) // 2D or 1x1x1x...x2D
        {
            switch (dObj->getType())
            {
            case ito::tUInt8: {
                ...
                else
                {
                    ...
                    ito::dObjHelper::minMaxValue(
                        dObj, lowLimit, minPos, highLimit, maxPos, true, 0);
                }
                ito::uint8 threshold = ((highLimit + lowLimit) / 2.0);
                itom::io::transformDatatoImage_Mono<ito::uint8>(
                    &image, dObj, imgFilename, threshold);
            }
            break;
            case ito::tInt8: {
                if (toggle == 0)
                ...
                ito::int8 threshold = ((highLimit + lowLimit) / 2.0);
                itom::io::transformDatatoImage_Mono<ito::int8>(
                    &image, dObj, imgFilename, threshold);
            }
            break;
            case ito::tInt16: {
                ...
                ito::int16 threshold = ((highLimit + lowLimit) / 2.0);
                itom::io::transformDatatoImage_Mono<ito::int16>(
                    &image, dObj, imgFilename, threshold);
            }
            break;
            case ito::tUInt16: {
                ...
                ito::uint16 threshold = ((highLimit + lowLimit) / 2.0);
                itom::io::transformDatatoImage_Mono<ito::uint16>(
                    &image, dObj, imgFilename, threshold);
            }
            break;
            case ito::tInt32: {
                ...
                ito::int32 threshold = ((highLimit + lowLimit) / 2.0);
                itom::io::transformDatatoImage_Mono<ito::int32>(
                    &image, dObj, imgFilename, threshold);
            }
            break;
                // case ito::tUInt32:
            ...
            case ito::tFloat32: {
                ...
                ito::float32 threshold = ((highLimit + lowLimit) / 2.0);
                itom::io::transformDatatoImage_Mono<ito::float32>(
                    &image, dObj, imgFilename, threshold);
            }
            case ito::tFloat64: {
                if (toggle == 0)
                ...
                ito::float64 threshold = ((highLimit + lowLimit) / 2.0);
                itom::io::transformDatatoImage_Mono<ito::float64>(
                    &image, dObj, imgFilename, threshold);
            }
            break;
            default:
                ret += ito::RetVal(
                    ito::retError,
                    0,
                    tr("Save to image failed: DataObjectType is not supported").toLatin1().data());
            }
        }
        else
        {
            ret += ito::RetVal(
                ito::retError,
                0,
                tr("Save to image failed: Only 2D DataObject is supported").toLatin1().data());
        }
    }
    ...
    else if (imgFormat.compare("QImage::Format_MonoLSB") == 0)
    {
            ...
            (dObj->getDims() > 2 && dObj->calcNumMats() == 1)) // 2D or 1x1x1x...x2D
        {
            ...
            case ito::tUInt8: {
                ...
                ito::uint8 threshold = ((highLimit + lowLimit) / 2.0);
                itom::io::transformDatatoImage_MonoLSB<ito::uint8>(
                    &image, dObj, imgFilename, threshold);
            }
            break;
            case ito::tInt8: {
                ...
                ito::int8 threshold = ((highLimit + lowLimit) / 2.0);
                itom::io::transformDatatoImage_MonoLSB<ito::int8>(
                    &image, dObj, imgFilename, threshold);
            }
            break;
            case ito::tInt16: {
                ...
                ito::int16 threshold = ((highLimit + lowLimit) / 2.0);
                itom::io::transformDatatoImage_MonoLSB<ito::int16>(
                    &image, dObj, imgFilename, threshold);
            }
            break;
            case ito::tUInt16: {
                ...
                ito::uint16 threshold = ((highLimit + lowLimit) / 2.0);
                itom::io::transformDatatoImage_MonoLSB<ito::uint16>(
                    &image, dObj, imgFilename, threshold);
            }
            break;
            case ito::tInt32: {
                ...
                ito::int32 threshold = ((highLimit + lowLimit) / 2.0);
                itom::io::transformDatatoImage_MonoLSB<ito::int32>(
                    &image, dObj, imgFilename, threshold);
            }
            break;
                // case ito::tUInt32:
                //     itom::io::transformDatatoImage_MonoLSB<ito::uint32>(&image, dObj,
                //     imgFilename);
                // break;
            ...
            case ito::tFloat32: {
                ...
                ito::float32 threshold = ((highLimit + lowLimit) / 2.0);
                itom::io::transformDatatoImage_MonoLSB<ito::float32>(
                    &image, dObj, imgFilename, threshold);
            }
            case ito::tFloat64: {
                if (toggle == 0)
                ...
                ito::float64 threshold = ((highLimit + lowLimit) / 2.0);
                itom::io::transformDatatoImage_MonoLSB<ito::float64>(
                    &image, dObj, imgFilename, threshold);
            }
            break;
            default:
        ...
        {
            ret += ito::RetVal(
                ito::retError, 0, tr("Only 2D DataObject is supported").toLatin1().data());
        }
    }
    ...
    else if (imgFormat.compare("QImage::Format_Indexed8") == 0)
    {
            ...
            (dObj->getDims() > 2 && dObj->calcNumMats() == 1)) // 2D or 1x1x1x...x2D
        {
            ...
            {
            case ito::tUInt8:
                itom::io::transformDatatoImage_Indexed8<ito::uint8>(
                    &image, dObj, imgFilename, lowLimit, scaling, doScaling, colorMap);
                break;
            case ito::tInt8:
                itom::io::transformDatatoImage_Indexed8<ito::int8>(
                    &image, dObj, imgFilename, lowLimit, scaling, doScaling, colorMap);
                break;
            case ito::tInt16:
                itom::io::transformDatatoImage_Indexed8<ito::int16>(
                    &image, dObj, imgFilename, lowLimit, scaling, doScaling, colorMap);
                break;
            case ito::tUInt16:
                itom::io::transformDatatoImage_Indexed8<ito::uint16>(
                    &image, dObj, imgFilename, lowLimit, scaling, doScaling, colorMap);
                break;
            case ito::tInt32:
                itom::io::transformDatatoImage_Indexed8<ito::int32>(
                    &image, dObj, imgFilename, lowLimit, scaling, doScaling, colorMap);
                break;
                // case ito::tUInt32:
                //     itom::io::transformDatatoImage_MonoLSB<ito::uint32>(&image, dObj,
                //     imgFilename, lowLimit, scaling, doScaling);
                // break;

            case ito::tFloat32:
                itom::io::transformDatatoImage_Indexed8<ito::float32>(
                    &image, dObj, imgFilename, lowLimit, scaling, doScaling, colorMap);
            case ito::tFloat64:
                itom::io::transformDatatoImage_Indexed8<ito::float64>(
                    &image, dObj, imgFilename, lowLimit, scaling, doScaling, colorMap);
                break;
            default:
                ret += ito::RetVal(
    ...
    else if (imgFormat.compare("QImage::Format_RGB32") == 0)
    {
            ...
            (dObj->getDims() > 2 && dObj->calcNumMats() == 1)) // 2D or 1x1x1x...x2D
        {
            ...
            {
            case ito::tUInt8:
                itom::io::transformDatatoImage_RGB32<ito::uint8>(
                    &image, dObj, imgFilename, lowLimit, scaling, doScaling, false);
                break;
            case ito::tInt8:
                itom::io::transformDatatoImage_RGB32<ito::int8>(
                    &image, dObj, imgFilename, lowLimit, scaling, doScaling, false);
                break;
            case ito::tInt16:
                itom::io::transformDatatoImage_RGB32<ito::int16>(
                    &image, dObj, imgFilename, lowLimit, scaling, doScaling, false);
                break;
            case ito::tUInt16:
                itom::io::transformDatatoImage_RGB32<ito::uint16>(
                    &image, dObj, imgFilename, lowLimit, scaling, doScaling, false);
                break;
            case ito::tInt32:
                itom::io::transformDatatoImage_RGB32<ito::int32>(
                    &image, dObj, imgFilename, lowLimit, scaling, doScaling, false);
                break;
                // case ito::tUInt32:
                //     itom::io::transformDatatoImage_MonoLSB<ito::uint32>(&image, dObj,
                //     imgFilename, lowLimit, scaling, doScaling, false);
                // break;

            case ito::tFloat32:
                itom::io::transformDatatoImage_RGB32<ito::float32>(
                    &image, dObj, imgFilename, lowLimit, scaling, doScaling, false);
            case ito::tFloat64:
                itom::io::transformDatatoImage_RGB32<ito::float64>(
                    &image, dObj, imgFilename, lowLimit, scaling, doScaling, false);
                break;
            default:
                ret += ito::RetVal(
            ...
            (dObj->getType() == ito::tUInt8) &&
            (dObj->getDims() > 2 && dObj->calcNumMats() == 3)) // RGB-Planes
        {
            double scaling = 1.0;
            ...
            case ito::tUInt8:
                itom::io::transformDatatoImage_RGB32<ito::uint8>(
                    &image, dObj, imgFilename, lowLimit, scaling, doScaling, true);
                break;
            case ito::tInt8:
                itom::io::transformDatatoImage_RGB32<ito::int8>(
                    &image, dObj, imgFilename, lowLimit, scaling, doScaling, true);
            ...
            case ito::tInt32:
                ...
                // case ito::tUInt32:
                //     itom::io::transformDatatoImage_MonoLSB<ito::uint32>(&image, dObj,
                //     imgFilename, lowLimit, scaling, doScaling, true);
                // break;
    ...
    else if (imgFormat.compare("QImage::Format_ARGB32") == 0)
    {
            ...
            (dObj->getDims() > 2 && dObj->calcNumMats() == 1)) // 2D or 1x1x1x...x2D
        {
            ...
            {
            case ito::tUInt8:
                itom::io::transformDatatoImage_ARGB32<ito::uint8>(
                    &image, dObj, imgFilename, lowLimit, scaling, doScaling, false);
                break;
            case ito::tInt8:
                itom::io::transformDatatoImage_ARGB32<ito::int8>(
                    &image, dObj, imgFilename, lowLimit, scaling, doScaling, false);
                break;
            case ito::tInt16:
                itom::io::transformDatatoImage_ARGB32<ito::int16>(
                    &image, dObj, imgFilename, lowLimit, scaling, doScaling, false);
                break;
            case ito::tUInt16:
                itom::io::transformDatatoImage_ARGB32<ito::uint16>(
                    &image, dObj, imgFilename, lowLimit, scaling, doScaling, false);
                break;
            case ito::tInt32:
                itom::io::transformDatatoImage_ARGB32<ito::int32>(
                    &image, dObj, imgFilename, lowLimit, scaling, doScaling, false);
                break;
                // case ito::tUInt32:
                //     itom::io::transformDatatoImage_ARGB32<ito::uint32>(&image, dObj, imgFilename,
                //     lowLimit, scaling, doScaling, false);
                // break;

            case ito::tFloat32:
                itom::io::transformDatatoImage_ARGB32<ito::float32>(
                    &image, dObj, imgFilename, lowLimit, scaling, doScaling, false);
            case ito::tFloat64:
                itom::io::transformDatatoImage_ARGB32<ito::float64>(
                    &image, dObj, imgFilename, lowLimit, scaling, doScaling, false);
                break;
            default:
                ret += ito::RetVal(
            ...
            (dObj->getDims() > 2 && dObj->calcNumMats() == 4)) // RGBA-Planes
        {
            double scaling = 1.0;
            bool doScaling = false;
            ...
            case ito::tInt32:
                ...
                // case ito::tUInt32:
                //     itom::io::transformDatatoImage_ARGB32<ito::uint32>(&image, dObj, imgFilename,
                //     lowLimit, scaling, doScaling, true);
                // break;
    ...
    {
        ret += ito::RetVal(
            ito::retError, 0, tr("Entered Image format is not supported").toLatin1().data());
    }
    return ret;
}
...
//----------------------------------------------------------------------------------------------------------------------------------
/*static*/ const QString DataObjectIO::loadDataObjectDoc =
    QObject::tr("loads a 2D data object from image formats via QImage (*.gif *.xbm *.xpm). \n\
 ...
 *   This Function interacts with itom Python application, constructs plugin functionality, creates
 * necessary parameters (eg. Mandatory and Optional parameters) and their specifications as required
 * for converting the specified Image from its specified location on Hard drive into itom
 * DataObject.
 */
ito::RetVal DataObjectIO::loadDataObjectParams(
    QVector<ito::Param>* paramsMand, QVector<ito::Param>* paramsOpt, QVector<ito::Param>* paramsOut)
{
    ito::RetVal retval = prepareParamVectors(paramsMand, paramsOpt, paramsOut);
    if (!retval.containsError())
    {
        ito::Param param = ito::Param(
            ...
            NULL,
            tr("Empty dataObjet").toLatin1().data());
        paramsMand->append(param);
        param = ito::Param(
            "filename",
            ito::ParamBase::String | ito::ParamBase::In,
            NULL,
            tr("Source file name").toLatin1().data());
        paramsMand->append(param);
        ...
        param = ito::Param(
            ...
            ito::ParamBase::String | ito::ParamBase::In,
            "asIs",
            tr("Color element: asIs (default) | alpha | R | G | B | RGB | ARGB | GRAY; 'asIs' "
               "ignores alpha channel from supported file types (use rgba instead).")
                .toLatin1()
                .data());
 ...
 *
 *   This Function accepts parameters from itom Python application according to specification
 * provided by "loadDataObjectParams" function. It retrieves the Image data from Image location
 * passed as parameter from Hard drive and loads a corresponding Itom DataObject.
 */
ito::RetVal DataObjectIO::loadDataObject(
    QVector<ito::ParamBase>* paramsMand,
    QVector<ito::ParamBase>* paramsOpt,
    QVector<ito::ParamBase>* /*paramsOut*/)
{
    ...
    if (!fileinfo.exists())
    {
        ret += ito::RetVal::format(
            ito::retError, 0, tr("The file '%s' does not exist.").toLatin1().data(), filename);
    }
    else if (!image.load(QLatin1String(filename)))
    {
        ret += ito::RetVal::format(
            ito::retError,
            0,
            tr("The file '%s' is no readable image file.").toLatin1().data(),
            filename);
    }
    else
    {
        ...
        if (imgFormat == QImage::Format_Mono ||
            imgFormat ==
                QImage::Format_MonoLSB) // Case for Format_Mono and Format_MonoLSB images. Note: All
                                        // Format_MonoLSB images are detected as Format_Mono images
                                        // so No special case for Format_MonoLSB.
        {
        ...
        else if (imgFormat == QImage::Format_RGB32) // Case for Format_RGB32 images
        {
            if (dObjDst->getType() == ito::tRGBA32)
            {
                ret += itom::io::QImage_ARGB32_to_dataObject<ito::Rgba32>(
                    &image, dObjDst, colorElem.data());
            }
            else
            {
                ret += itom::io::QImage_ARGB32_to_dataObject<ito::uint8>(
                    &image, dObjDst, colorElem.data());
            }
        }
        ...
        {
            ret += ito::RetVal(
                ito::retError, 0, tr("Image does not have supported format").toLatin1().data());
        }
    }
    return ret;
}
...
//! saveNistSDFParams
//----------------------------------------------------------------------------------------------------------------------------------
/*static*/ const QString DataObjectIO::saveNistSDFDoc =
    QObject::tr("saves 1D and 2D dataObject to the ascii surface data file format (sdf), version "
                "aNIST-1.0 (no official standard) or aISO-1.0 (in compliance with ISO 25178-71).");
 ...
 *   This Function interacts with itom Python application, constructs plugin functionality, creates
 * necessary parameters (eg. Mandatory and Optional parameters) and their specifications as required
 * for converting DataObject into Raw-Text data and save it into Hard drive.
 */
ito::RetVal DataObjectIO::saveNistSDFParams(
    QVector<ito::Param>* paramsMand, QVector<ito::Param>* paramsOpt, QVector<ito::Param>* paramsOut)
{
    ito::RetVal retval = prepareParamVectors(paramsMand, paramsOpt, paramsOut);
    if (!retval.containsError())
    {
        ...
        param = ito::Param(
            ...
            12,
            3,
            tr("Number of decimal signs (default: 3). For MountainsMaps reduce total number of "
               "digits to 5")
                .toLatin1()
                .data());
        paramsOpt->append(param);
        param = ito::Param(
            ...
            12,
            -3,
            tr("Power of 10 for the zValue (Default: -3, micrometer), only for floating point "
               "objects.")
                .toLatin1()
                .data());
        paramsOpt->append(param);
        param = ito::Param(
            ...
            3,
            0,
            tr("Toggles NaN handling if dataObject is floating-type. 0: Write NaN (Default); 1: "
               "Skip Value, 2: Substitute by InvalidValue, 3: Substitute by BAD for MountainsMaps.")
                .toLatin1()
                .data());
        paramsOpt->append(param);
        param = ito::Param(
            ...
            std::numeric_limits<double>::max(),
            -42.0,
            tr("New value for invalid substitution. Default is 0.0").toLatin1().data());
        paramsOpt->append(param);
        param = ito::Param(
            "version",
            ito::ParamBase::String | ito::ParamBase::In,
            "aNIST-1.0",
            tr("File format version: 'aNIST-1.0' or 'aISO-1.0' for DIN EN ISO 25178-71")
                .toLatin1()
                .data());
 ...
 *
 *   This Function accepts parameters from itom Python application according to specification
 * provided by "saveNistSDF" function. It retrieves the raw-data from the dataObject and writes them
 * as ascii-data to the location passed as parameter from Hard drive and loads a corresponding Itom
 * DataObject.
 *
 *   see http://physics.nist.gov/VSC/jsp/DataFormat.jsp#a or
 * http://resource.npl.co.uk/softgauges/Help.htm
 *
 *   see also K. J. Stout, P. J. Sullivan, W. P. Dong, E. Mainsah, N. Lou, T. Mathia and H.
 * Zahouani, The Development of Methods for The Characterisation of Roughness in Three Dimensions,
 * Report EUR 15178 EN. EC Brussels, 1993
 */
ito::RetVal DataObjectIO::saveNistSDF(
    QVector<ito::ParamBase>* paramsMand,
    QVector<ito::ParamBase>* paramsOpt,
    QVector<ito::ParamBase>* /*paramsOut*/)
{
    ...
    ret += ito::dObjHelper::verify2DDataObject(
        dObjSrc,
        "sourceImage",
        1,
    ...
    else if (!dataOut.open(QIODevice::WriteOnly))
    {
        ret += ito::RetVal::format(
            ito::retError,
            0,
            tr("The file '%s' is no writeable file.").toLatin1().data(),
    ...
    if (!ret.containsWarningOrError())
    {
        ...
        if (tag.empty())
        {
            outLine = ("Zresolution\t\t= -1\n"); // negative is unknown concerning aBCR1.0 or
                                                 // aISO1.0 standard
        }
        else
        {
        ...
        {
        case ito::tUInt8:
            writeDataBlock<ito::uint8>(
                dataOut, dObjSrc, 1 / verticalScale, decimals, flags, ' ', newInvalidValue);
            break;
        case ito::tUInt16:
            writeDataBlock<ito::uint16>(
                dataOut, dObjSrc, 1 / verticalScale, decimals, flags, ' ', newInvalidValue);
            break;
        case ito::tUInt32:
            writeDataBlock<ito::uint32>(
                dataOut, dObjSrc, 1 / verticalScale, decimals, flags, ' ', newInvalidValue);
            break;
        case ito::tInt8:
            writeDataBlock<ito::int8>(
                dataOut, dObjSrc, 1 / verticalScale, decimals, flags, ' ', newInvalidValue);
            break;
        case ito::tInt16:
            writeDataBlock<ito::int16>(
                dataOut, dObjSrc, 1 / verticalScale, decimals, flags, ' ', newInvalidValue);
            break;
        case ito::tInt32:
            writeDataBlock<ito::int32>(
                dataOut, dObjSrc, 1 / verticalScale, decimals, flags, ' ', newInvalidValue);
            break;
        case ito::tFloat32:
            writeDataBlock<ito::float32>(
                dataOut, dObjSrc, 1 / verticalScale, decimals, flags, ' ', newInvalidValue);
            break;
        case ito::tFloat64:
            writeDataBlock<ito::float64>(
                dataOut, dObjSrc, 1 / verticalScale, decimals, flags, ' ', newInvalidValue);
            break;
        }
...
//! writeDataBlock
//----------------------------------------------------------------------------------------------------------------------------------
/** readDataBlock method, read the data-block of a .sdf-nist metrology file and write data to the
...
ito::RetVal DataObjectIO::writeDataBlock(
    QFile& outFile,
    const ito::DataObject* scrObject,
    const double zScale,
    const int decimals,
    const int flags,
        ...
        else
        {
            ...
            case DataObjectIO::invIgnor:
                for (y = 0; y < ysize; y++)
                {
                    ...
                    for (x = 0; x < xsize - 1; x++)
                    {
                        if (ito::isFinite<_Tp>(p_Dst[x]))
                            curLine.append(QByteArray::number(p_Dst[x] * zScale, 'f', decimals));
                        curLine.append(separator);
                    }
                    if (ito::isFinite<_Tp>(p_Dst[xsize - 1]))
                        curLine.append(
                            QByteArray::number(p_Dst[xsize - 1] * zScale, 'f', decimals));
                    curLine.append('\n');
                    outFile.write(curLine);
                }
                break;
                ...
                for (y = 0; y < ysize; y++)
                {
                    ...
                    for (x = 0; x < xsize - 1; x++)
                    {
                        if (ito::isFinite<_Tp>(p_Dst[x]))
                            ...
                            curLine.append(QByteArray::number(nanValue, 'f', decimals));
                        curLine.append(separator);
                    }
                    if (ito::isFinite<_Tp>(p_Dst[xsize - 1]))
                        curLine.append(
...
//! loadNistSDFParams
//----------------------------------------------------------------------------------------------------------------------------------
/*static*/ const QString DataObjectIO::loadNistSDFDoc =
    QObject::tr("loads an ascii or binary-based surface data file to a 1D or 2D data object (sdf), "
                "versions aNIST-1.0, aISO-1.0, bISO-1.0 (ISO 25178-71) or aBCR-1.0 (e.g. Zygo "
                "export format) are supported.");
 ...
 * for converting DataObject into Raw-Text data and save it into Hard drive.
 */
ito::RetVal DataObjectIO::loadNistSDFParams(
    QVector<ito::Param>* paramsMand, QVector<ito::Param>* paramsOpt, QVector<ito::Param>* paramsOut)
{
    ito::RetVal retval = prepareParamVectors(paramsMand, paramsOpt, paramsOut);
    if (!retval.containsError())
    {
        ito::Param param = ito::Param(
            ...
            ito::ParamBase::DObjPtr | ito::ParamBase::In | ito::ParamBase::Out,
            NULL,
            tr("data object where the file data is loaded to. The type of destinationObject "
               "corresponds to the type of the data block in the sdf file (uint8, uint16, uint32, "
               "int8, int16, int32, float32, float64) or always float64 if the header value Zscale "
               "is != 1.0 or the valueUnit is != 'm'")
                .toLatin1()
                .data());
        paramsMand->append(param);
        ...
        param = ito::Param(
            ...
            ito::ParamBase::String | ito::ParamBase::In,
            NULL,
            tr("filename of the sdf file (aISO-1.0, aNIST-1.0, aBCR-1.0 or bISO-1.0 format)")
                .toLatin1()
                .data());
        paramsMand->append(param);
        ...
        param = ito::Param(
            ...
            ito::ParamBase::String | ito::ParamBase::In,
            "mm",
            tr("Unit of x and y axes. Nist or BCR sdf files assumes to have m as default unit, "
               "this can be scaled using other values than m. Default: m (Be careful that other "
               "units than 'm' lead to a multiplication of all values that might exceed the data "
               "type limit.)")
                .toLatin1()
                .data());
        ...
        param = ito::Param(
            ...
            ito::ParamBase::String | ito::ParamBase::In,
            "mm",
            tr("Unit of value axis. x3p assumes to have m as default unit, this can be scaled "
               "using other values than m. Default: m (Be careful that other units than 'm' lead "
               "to a multiplication of all values that might exceed the data type limit.)")
                .toLatin1()
                .data());
        ...
        param = ito::Param(
            ...
            ito::ParamBase::String | ito::ParamBase::In,
            "BAD",
            tr("If this string occurs in the data block, the value will be replaced by NaN if "
               "float32 or float64 as output format. If '<minrange>' or <maxrange> the minimum or "
               "maximum value of the data type in the data block is assumed (e.g. <maxrange> is "
               "used by Zygo to describe NaN values). MountainsMap writes 'BAD' as invalid value "
               "(following ISO25178-71). This value is ignored for binary input since invalid "
               "values are directly encoded in floating point values.")
                .toLatin1()
                .data());
        paramsOpt->append(param);
    }
...
*
*   This Function accepts parameters from itom Python application according to specification
provided by "loadNistSDF" function.
*    It retrieves the ascii-data from file location passed as parameter from Hard drive and loads a
corresponding Itom DataObject.
*
*   see http://physics.nist.gov/VSC/jsp/DataFormat.jsp#a or
http://resource.npl.co.uk/softgauges/Help.htm
*
*   see also K. J. Stout, P. J. Sullivan, W. P. Dong, E. Mainsah, N. Lou, T. Mathia and H. Zahouani,
The Development of Methods for The Characterisation of Roughness in Three Dimensions, Report EUR
15178 EN. EC Brussels, 1993

*/
ito::RetVal DataObjectIO::loadNistSDF(
    QVector<ito::ParamBase>* paramsMand,
    QVector<ito::ParamBase>* paramsOpt,
    QVector<ito::ParamBase>* /*paramsOut*/)
{
    ...
    {
        ret += ito::RetVal::format(
            ito::retError, 0, tr("Dataobject not initialized").toLatin1().data(), filename);
    }
    ...
    {
        ret += ito::RetVal::format(
            ito::retError, 0, tr("The file '%s' is no readable file.").toLatin1().data(), filename);
    }
    else
    {
        ...
        {
            ret += ito::RetVal(
                ito::retError, 0, tr("No version tag could be found in file.").toLatin1().data());
        }
...
//! readNistHeader
//----------------------------------------------------------------------------------------------------------------------------------
/** readNistHeader method, read the header of a .sdf-nist metrology file and create corresponding
 * dataObject.
 *   @param [in] inFile      Readonly File
 ...
 *   @param [int] flags      For later improvements, not used yet
 *   @param [in/out] nanString if nanString is auto, it will be set to a byte array with the highest
 * possible value for the type. If this value occurs, it will be set to NaN further on (only in
 * float32 or float64)
 */
ito::RetVal DataObjectIO::readNistHeader(
    QFile& inFile,
    ito::DataObject& newObject,
    double& zscale,
    const int /*flags*/,
    const std::string& xyUnit,
    const std::string& valueUnit,
    QByteArray& nanString)
{
    ito::RetVal retValue;
    ...
    if (!stringLine.contains("aNIST-1.0", Qt::CaseInsensitive) &&
        !stringLine.contains("aBCR-1.0", Qt::CaseInsensitive) &&
        !stringLine.contains("aISO-1.0", Qt::CaseInsensitive))
    {
        return ito::RetVal::format(
            ito::retError,
            0,
            tr("The file '%s' does not contain an 'aNIST-1.0', 'aISO-1.0' or 'aBCR-1.0'-header.")
                .toLatin1()
                .data(),
            inFile.fileName().toLatin1().data());
    }
    ...
    if (it != rawMetaData.constEnd()) // Manufacturer ID, Unsigned Char, 10-bytes
    {
        ...
        {
            retValue +=
                ito::RetVal(ito::retWarning, 0, "Header ManufacID is longer than 10 characters");
        }
    }
    ...
    if (it != rawMetaData.constEnd()) // Create Date and Time, Unsigned Char, 12-bytes
    {
        ...
        {
            retValue += ito::RetVal(
                ito::retWarning, 0, "Length of header CreateDate is different than 12 characters");
        }
        else
        {
            ...
            if (date.isValid())
            {
                metaData["CreateDate"] = date.toString("yyyy-MM-ddTHH:mm:00.0+00:00")
                                             .toStdString(); // same format than x3p format
            }
            else
            {
                retValue += ito::RetVal(
                    ito::retWarning,
                    0,
                    "Header CreateDate can not be parsed in format DDMMYYYYHHMM");
            }
        }
    }
    ...
    if (it != rawMetaData.constEnd()) // Modified Date and Time, Unsigned Char, 12-bytes
    {
        ...
        {
            retValue += ito::RetVal(
                ito::retWarning, 0, "Length of header ModDate is different than 12 characters");
        }
        else
        {
            QDateTime date = QDateTime::fromString(*it, "ddMMyyyyHHmm");
            if (date.isValid())
            {
                metaData["ModDate"] = date.toString("yyyy-MM-ddTHH:mm:00.0+00:00")
                                          .toStdString(); // same format than x3p format
            }
            else
            {
                retValue += ito::RetVal(
                    ito::retWarning, 0, "Header ModDate can not be parsed in format DDMMYYYYHHMM");
            }
        }
    }
    ...
    if (it != rawMetaData.constEnd()) // Number of points in a profile, Unsigned Int, 2-bytes
    {
        ...
        {
            retValue +=
                ito::RetVal(ito::retError, 0, "Header NumPoints can not be interpreted as integer");
        }
    ...
    if (it != rawMetaData.constEnd()) // Number of profiles in a data file, Unsigned Int, 2-bytes
    {
        ...
        {
            retValue += ito::RetVal(
                ito::retError, 0, "Header NumProfiles can not be interpreted as integer");
        }
    ...
    {
        retValue +=
            ito::RetVal(ito::retError, 0, "height or width of file is <= 0. No data is loaded.");
    }

    it = rawMetaData.constFind("xscale");
    if (it != rawMetaData.constEnd()) // X-scale. A x-scale value of 1.00 E-6 represents a sample
                                      // spacing of 1 micrometer, Double, 8-bytes
    {
        xscale = it->toDouble(&ok);
        if (!ok)
        {
            retValue +=
                ito::RetVal(ito::retError, 0, "Header Xscale can not be interpreted as double");
        }
    }

    it = rawMetaData.constFind("yscale");
    if (it != rawMetaData.constEnd()) // Y-scale. A y-scale value of 1.00 E-6 represents a sample
                                      // spacing of 1 micrometer, Double, 8-bytes
    {
        ...
        {
            retValue +=
                ito::RetVal(ito::retError, 0, "Header Yscale can not be interpreted as double");
        }
    }

    it = rawMetaData.constFind("zscale");
    if (it != rawMetaData.constEnd()) // Z-scale. A z-scale value of 1.00 E-6 represents a height of
                                      // 1 micrometer, Double, 8-bytes
    {
        zscale = it->toDouble(&ok);
        if (!ok)
        {
            retValue +=
                ito::RetVal(ito::retError, 0, "Header Zscale can not be interpreted as double");
        }
    }
    ...
    if (it != rawMetaData.constEnd()) // Z- resolution, Double, 8-bytes
    {
        ...
        {
            retValue += ito::RetVal(
                ito::retError, 0, "Header Zresolution can not be interpreted as double");
        }
        else if (zRes < 0.0)
        {
    ...
    if (it != rawMetaData.constEnd())
    {
        if (it->toLower() != "null" && it->toLower() != "0")
        {
            retValue += ito::RetVal(
                ito::retError,
                0,
                "Header Compression must be 0 or NULL. Other compressions not supported by this "
                "filter and not specified in ISO25178-71.");
        }
    }
    ...
    if (it != rawMetaData.constEnd())
    {
        if (it->toLower() != "null" && it->toLower() != "0")
        {
            retValue += ito::RetVal(
                ito::retWarning,
                0,
                "Header CheckType must be 0 or NULL. Other check sum types are ignored by this "
                "filter and not specified in ISO25178-71.");
        }
    }
    ...
    if (it != rawMetaData.constEnd())
    {
        ...
        {
            retValue +=
                ito::RetVal(ito::retError, 0, "Header DataType cannot be interpreted as integer");
        }
        else
        {
            switch (dataType)
            ...
            case 0:
                dataType = ito::tUInt8;
                if (nanString == "<maxrange>")
                    nanString = "255";
                if (nanString == "<minrange>")
                    nanString = "0";
                break;
            case 1:
            ...
            case 6:
                dataType = ito::tInt32;
                if (nanString == "<maxrange>")
                    nanString = "2147483647";
                if (nanString == "<minrange>")
                    nanString = "-2147483648";
                break;
            case 7:
            ...
            if (dataType != -1 &&
                (valueUnit != "m" ||
                 std::abs(zscale - 1.0) > std::numeric_limits<double>::epsilon()))
            {
                dataType = ito::tFloat64;
            }
        }
    ...
    if (!retValue.containsError() && dataType > -1 && xsize > 0 && ysize > 0)
    {
        ...
        // zscale *= zRes; //the resolution is not multiplied to the values since it only indicates
        // the uncertainty of each discretized value (according to aBCR1.0 standard, basis for and
        // referenced by aNIST1.0 standard)
...
//----------------------------------------------------------------------------------------------------------------------------------
ito::RetVal DataObjectIO::readNistHeaderBinary(
    QFile& inFile,
    ito::DataObject& newObject,
    double& zscale,
    const int /*flags*/,
    ...
    QByteArray& nanString)
{
    ...
    {
        retValue += ito::RetVal(
            ito::retWarning, 0, "Header CreateDate can not be parsed in format DDMMYYYYHHMM");
    }
    ...
    if (!retValue.containsError())
    {
        ...
        {
            retValue +=
                ito::RetVal(ito::retError, 0, "file size is too small for all required data.");
        }
    }
    ...
    {
        if (dataType != -1 &&
            (valueUnit != "m" || std::abs(zscale - 1.0) > std::numeric_limits<double>::epsilon()) &&
            newObject.getType() != ito::tFloat64)
        {
            ito::DataObject temp;
 ...
 */
template <typename _Tp>
ito::RetVal DataObjectIO::readDataBlock(
    QFile& inFile,
    ito::DataObject& newObject,
    const double zScale,
    const int /*flags*/,
    const QByteArray& nanString)
{
    ito::RetVal ret(ito::retOk);
    ...
    // data block must not be organized such that every row in matrix corresponds to one row in data
    // block (see aBCR-1.0 standard)
    while (!curLine.contains("*") && !inFile.atEnd() && c < total)
    {
        // this loop gets every line in the file and extracts ranges of characters separated by one
        // or multiple space characters (' ', tab, \r, \n...) every range item is then converted to
        // a number and set into the array.
        ...
        while (end < len) // there are still characters left
        {
            ...
            if (end <= len && c < total)
            {
                ...
                if (std::numeric_limits<_Tp>::is_exact)
                {
                    // exact data type is only possible, if zScale is equal to 1, else the data type
                    // is automatically switched to float64 in read-header-method
    ...
    if (c != total)
    {
        ret += ito::RetVal(
            ito::retWarning,
            0,
            tr("number of values in data block does not correspond to NumPoints * NumProfiles of "
               "header block")
                .toLatin1()
                .data());
    }
...
/** saveTiffParams method, specifies the parameter list for saveDataObjectOpenCV as .Tiff images
 * method.
 *   @param [in] paramsMand  mandatory argument parameters
 *   @param [in] paramsOpt   optional argument parameters
 *    @param [out] outVals   optional output parameters
 ...
 * for converting DataObject into Image and save it into Hard drive.
 */
ito::RetVal DataObjectIO::saveTiffParams(
    QVector<ito::Param>* paramsMand, QVector<ito::Param>* paramsOpt, QVector<ito::Param>* paramsOut)
{
    ito::RetVal retval = prepareParamVectors(paramsMand, paramsOpt, paramsOut);
    if (!retval.containsError())
    {
        ito::Param param = ito::Param(
            ...
            ito::ParamBase::DObjPtr | ito::ParamBase::In,
            NULL,
            tr("Real, 2D data object").toLatin1().data());
        paramsMand->append(param);
        param = ito::Param(
            "filename",
            ito::ParamBase::String | ito::ParamBase::In,
        ...
        param = ito::Param(
            ...
            ito::ParamBase::String | ito::ParamBase::In,
            "gray16",
            tr("Color palette name [gray, gray16, ...]").toLatin1().data());
        paramsMand->append(param);
    }
 ...
 *
 *   This Function accepts parameters from itom Python application according to specification
 * provided by "saveTiffParams" function. Redirected to "saveDataObjectOpenCV"
 */
ito::RetVal DataObjectIO::saveTiff(
    QVector<ito::ParamBase>* paramsMand,
    QVector<ito::ParamBase>* paramsOpt,
    QVector<ito::ParamBase>* paramsOut)
{
...
/** saveJPGParams method, specifies the parameter list for saveDataObjectOpenCV as .jpg and .jpg2000
 * images method.
 *   @param [in] paramsMand  mandatory argument parameters
 *   @param [in] paramsOpt   optional argument parameters
 *    @param [out] outVals   optional output parameters
 ...
 * for converting DataObject into Image and save it into Hard drive.
 */
ito::RetVal DataObjectIO::saveJPGParams(
    QVector<ito::Param>* paramsMand, QVector<ito::Param>* paramsOpt, QVector<ito::Param>* paramsOut)
{
    ito::RetVal retval = prepareParamVectors(paramsMand, paramsOpt, paramsOut);
    if (!retval.containsError())
    {
        ...
        param = ito::Param(
            ...
            ito::ParamBase::String | ito::ParamBase::In,
            "falseColor",
            tr("Color palette name [gray, gray16, rgb, rgba, <any-name-of-a-color-palette>]. "
               "'gray16' supported for '.jp2' only")
                .toLatin1()
                .data());
        paramsMand->append(param);
        ...
        param = ito::Param(
            ...
            100,
            90,
            tr("Compression rate, 0: high, 100: low").toLatin1().data());
        paramsOpt->append(param);
    }
 ...
 *
 *   This Function accepts parameters from itom Python application according to specification
 * provided by "saveJPGParams" function. Redirected to "saveDataObjectOpenCV"
 */
ito::RetVal DataObjectIO::saveJPG(
    QVector<ito::ParamBase>* paramsMand,
    QVector<ito::ParamBase>* paramsOpt,
    QVector<ito::ParamBase>* paramsOut)
{
...
//! savePNGParams
//----------------------------------------------------------------------------------------------------------------------------------
/*static*/ const QString DataObjectIO::savePNGDoc =
    QObject::tr("Saves a real, 2D dataObject as png-file (portable network graphic). \n\
\n\
The following conventions hold for saving the image: \n\
\n\
* fixed-point data types (uint8, uint16, uint32, int8, int16, int32) will be scaled to the \n\
...
/** savePNGParams method, specifies the parameter list for saveDataObjectOpenCV as .png images
 * method.
 *   @param [in] paramsMand  mandatory argument parameters
 *   @param [in] paramsOpt   optional argument parameters
 *    @param [out] outVals   optional output parameters
 ...
 * for converting DataObject into Image and save it into Hard drive.
 */
ito::RetVal DataObjectIO::savePNGParams(
    QVector<ito::Param>* paramsMand, QVector<ito::Param>* paramsOpt, QVector<ito::Param>* paramsOut)
{
    ito::RetVal retval = prepareParamVectors(paramsMand, paramsOpt, paramsOut);
    if (!retval.containsError())
    {
        ...
        param = ito::Param(
            ...
            ito::ParamBase::String | ito::ParamBase::In,
            "falseColor",
            tr("Color palette name [gray, gray16, rgba, rgb, <any-name-of-a-color-palette>].")
                .toLatin1()
                .data());
        paramsMand->append(param);
        ...
        param = ito::Param(
            ...
            9,
            9,
            tr("Compression rate, 0: high, 9: low").toLatin1().data());
        paramsOpt->append(param);
        param = ito::Param(
            "addAlphaChannel",
            ito::ParamBase::Int | ito::ParamBase::In,
            ...
            1,
            1,
            tr("If enabled and in case of floating point values, invalid values will we "
               "transparent (alpha=0), else full opacity.")
                .toLatin1()
                .data());
        paramsOpt->append(param);
    }
 ...
 *
 *   This Function accepts parameters from itom Python application according to specification
 * provided by "savePNGParams" function. Redirected to "saveDataObjectOpenCV"
 */
ito::RetVal DataObjectIO::savePNG(
    QVector<ito::ParamBase>* paramsMand,
    QVector<ito::ParamBase>* paramsOpt,
    QVector<ito::ParamBase>* paramsOut)
{
 ...
 * for converting DataObject into Image and save it into Hard drive.
 */
ito::RetVal DataObjectIO::saveXPMParams(
    QVector<ito::Param>* paramsMand, QVector<ito::Param>* paramsOpt, QVector<ito::Param>* paramsOut)
{
    ito::RetVal retval = prepareParamVectors(paramsMand, paramsOpt, paramsOut);
    if (!retval.containsError())
    {
        ...
        param = ito::Param(
            ...
            ito::ParamBase::String | ito::ParamBase::In,
            "gray",
            tr("Color palette name [gray, rgba, rgb, <any-name-of-a-color-palette>].")
                .toLatin1()
                .data());
        paramsMand->append(param);
    }
 ...
 * provided by "savePNGParams" function. Redirected to "saveDataObjectOpenCV"
 */
ito::RetVal DataObjectIO::saveXPM(
    QVector<ito::ParamBase>* paramsMand,
    QVector<ito::ParamBase>* paramsOpt,
    QVector<ito::ParamBase>* paramsOut)
{
...
//! saveBMPParams
//----------------------------------------------------------------------------------------------------------------------------------
/*static*/ const QString DataObjectIO::saveBMPDoc =
    QObject::tr("Saves a real, 2D dataObject as bmp-file or dip-file (bitmap, 8bit only). \n\
\n\
The following conventions hold for saving the image: \n\
\n\
* fixed-point data types (uint8, uint16, uint32, int8, int16, int32) will be scaled to the \n\
...
/** saveBMPParams method, specifies the parameter list for saveDataObjectOpenCV as .bmp images
 * method.
 *   @param [in] paramsMand  mandatory argument parameters
 *   @param [in] paramsOpt   optional argument parameters
 *    @param [out] outVals   optional output parameters
 ...
 * for converting DataObject into Image and save it into Hard drive.
 */
ito::RetVal DataObjectIO::saveBMPParams(
    QVector<ito::Param>* paramsMand, QVector<ito::Param>* paramsOpt, QVector<ito::Param>* paramsOut)
{
    ito::RetVal retval = prepareParamVectors(paramsMand, paramsOpt, paramsOut);
    if (!retval.containsError())
    {
        ...
        param = ito::Param(
            ...
            ito::ParamBase::String | ito::ParamBase::In,
            "falseColor",
            tr("Color palette name [gray, rgb, <any-name-of-a-color-palette>, ...]")
                .toLatin1()
                .data());
        paramsMand->append(param);
    }
 ...
 *
 *   This Function accepts parameters from itom Python application according to specification
 * provided by "saveBMPParams" function. Redirected to "saveDataObjectOpenCV"
 */
ito::RetVal DataObjectIO::saveBMP(
    QVector<ito::ParamBase>* paramsMand,
    QVector<ito::ParamBase>* paramsOpt,
    QVector<ito::ParamBase>* paramsOut)
{
...
//! savePPMParams
//----------------------------------------------------------------------------------------------------------------------------------
/*static*/ const QString DataObjectIO::savePPMDoc =
    QObject::tr("Saves a real, 2D dataObject as ppm-file (portable pixel map, 8bit only). \n\
\n\
The following conventions hold for saving the image: \n\
\n\
* fixed-point data types (uint8, uint16, uint32, int8, int16, int32) will be scaled to the \n\
...
/** savePPMParams method, specifies the parameter list for saveDataObjectOpenCV as .ppm, .pgm, .pbm
 * images method.
 *   @param [in] paramsMand  mandatory argument parameters
 *   @param [in] paramsOpt   optional argument parameters
 *    @param [out] outVals   optional output parameters
 ...
 * for converting DataObject into Image and save it into Hard drive.
 */
ito::RetVal DataObjectIO::savePPMParams(
    QVector<ito::Param>* paramsMand, QVector<ito::Param>* paramsOpt, QVector<ito::Param>* paramsOut)
{
    ito::RetVal retval = prepareParamVectors(paramsMand, paramsOpt, paramsOut);
    if (!retval.containsError())
    {
        ...
        param = ito::Param(
            ...
            ito::ParamBase::String | ito::ParamBase::In,
            "falseColor",
            tr("Color palette name [gray, <any-name-of-a-color-palette>, ...]").toLatin1().data());
        paramsMand->append(param);
        param = ito::Param(
            "binaryOut",
            ito::ParamBase::Int | ito::ParamBase::In,
            ...
            1,
            1,
            tr("Enable binary coding").toLatin1().data());
        paramsOpt->append(param);
    }
 ...
 *
 *   This Function accepts parameters from itom Python application according to specification
 * provided by "savePPMParams" function. Redirected to "saveDataObjectOpenCV"
 */
ito::RetVal DataObjectIO::savePPM(
    QVector<ito::ParamBase>* paramsMand,
    QVector<ito::ParamBase>* paramsOpt,
    QVector<ito::ParamBase>* paramsOut)
{
...
/** savePGMParams method, specifies the parameter list for saveDataObjectOpenCV as .ppm, .pgm, .pbm
 * images method.
 *   @param [in] paramsMand  mandatory argument parameters
 *   @param [in] paramsOpt   optional argument parameters
 *    @param [out] outVals   optional output parameters
 ...
 * for converting DataObject into Image and save it into Hard drive.
 */
ito::RetVal DataObjectIO::savePGMParams(
    QVector<ito::Param>* paramsMand, QVector<ito::Param>* paramsOpt, QVector<ito::Param>* paramsOut)
{
    ito::RetVal retval = prepareParamVectors(paramsMand, paramsOpt, paramsOut);
    if (!retval.containsError())
 ...
 * provided by "savePPMParams" function. Redirected to "saveDataObjectOpenCV"
 */
ito::RetVal DataObjectIO::savePGM(
    QVector<ito::ParamBase>* paramsMand,
    QVector<ito::ParamBase>* paramsOpt,
    QVector<ito::ParamBase>* paramsOut)
{
...
//! saveRASParams
//----------------------------------------------------------------------------------------------------------------------------------
/*static*/ const QString DataObjectIO::saveRASDoc =
    QObject::tr("Saves a real, 2D dataObject as sr-file or ras-file (Sun Raster, 8bit only). \n\
\n\
The following conventions hold for saving the image: \n\
\n\
* fixed-point data types (uint8, uint16, uint32, int8, int16, int32) will be scaled to the \n\
...
/** savePPMParams method, specifies the parameter list for saveDataObjectOpenCV as .ras, .su images
 * method.
 *   @param [in] paramsMand  mandatory argument parameters
 *   @param [in] paramsOpt   optional argument parameters
 *    @param [out] outVals   optional output parameters
 ...
 * for converting DataObject into Image and save it into Hard drive.
 */
ito::RetVal DataObjectIO::saveRASParams(
    QVector<ito::Param>* paramsMand, QVector<ito::Param>* paramsOpt, QVector<ito::Param>* paramsOut)
{
    ito::RetVal retval = prepareParamVectors(paramsMand, paramsOpt, paramsOut);
    if (!retval.containsError())
    {
        ito::Param param = ito::Param(
            ...
            ito::ParamBase::DObjPtr | ito::ParamBase::In,
            NULL,
            tr("2D-DataObject of anytype").toLatin1().data());
        paramsMand->append(param);
        param = ito::Param(
            "filename",
            ito::ParamBase::String | ito::ParamBase::In,
        ...
        param = ito::Param(
            ...
            ito::ParamBase::String | ito::ParamBase::In,
            "falseColor",
            tr("Color palette name [gray, ...]").toLatin1().data());
        paramsMand->append(param);
    }
 ...
 *
 *   This Function accepts parameters from itom Python application according to specification
 * provided by "saveRASParams" function. Redirected to "saveDataObjectOpenCV"
 */
ito::RetVal DataObjectIO::saveRAS(
    QVector<ito::ParamBase>* paramsMand,
    QVector<ito::ParamBase>* paramsOpt,
    QVector<ito::ParamBase>* paramsOut)
{
...
//----------------------------------------------------------------------------------------------------------------------------------
void DataObjectIO::checkAndModifyFilenameSuffix(
    QFileInfo& file,
    const QString& desiredAndAllowedSuffix,
    const QString& allowedSuffix2 /*= QString()*/,
    const QString& allowedSuffix3 /*= QString()*/)
{
    QString suffix = file.suffix();
    bool wrongSuffix = true;
    if (!desiredAndAllowedSuffix.isNull() &&
        suffix.compare(desiredAndAllowedSuffix, Qt::CaseInsensitive) == 0)
    {
        wrongSuffix = false;
    }
    ...
    if (wrongSuffix)
    {
        QString fixedName = QString("%1/%2.%3")
                                .arg(file.absolutePath())
                                .arg(file.completeBaseName())
                                .arg(desiredAndAllowedSuffix);
 ...
 *
 *   This Function accepts parameters from itom Python application according to specification
 * provided by "save-Format-Params" function. It converts passed DataObject into corresponding Image
 * as per given Image Format and stores it to specific location provided on Hard drive.
 */
ito::RetVal DataObjectIO::saveDataObjectOpenCV(
    QVector<ito::ParamBase>* paramsMand,
    QVector<ito::ParamBase>* paramsOpt,
    QVector<ito::ParamBase>* /*paramsOut*/,
    const ImageFormat& imageFormat)
{
    ...
    if (dObj->calcNumMats() != 1)
    {
        ret += ito::RetVal(
            ito::retError,
            0,
            tr("The given dataObject must have exactly one plane").toLatin1().data());
    }
    else if (dObj->getType() == ito::tComplex128 || dObj->getType() == ito::tComplex64)
    {
        ret +=
            ito::RetVal(ito::retError, 0, tr("Complex data types not supported").toLatin1().data());
    }
    ...
    if (!folder.exists())
    {
        return ito::RetVal(
            ito::retError,
            0,
            tr("The target directory '%1' does not exist.")
    ...
    if (imgPalette.compare("gray") == 0)
    {
        ...
        default:
            return ito::RetVal(
                ito::retError,
                0,
                tr("DataObject-Type could not be converted to unsigned int 8-bit.")
                    .toLatin1()
                    .data());
        }
    }
    else if (imgPalette.compare("gray16") == 0)
    {
        if (gray16Supported)
        {
            ...
            default:
                return ito::RetVal(
                    ito::retError,
                    0,
                    tr("DataObject-Type could not be converted to unsigned int 16-bit.")
                        .toLatin1()
                        .data());
            }
        }
        else
        {
            return ito::RetVal(
                ito::retError,
                0,
                tr("Image format does not support 16-Bit gray values.").toLatin1().data());
        }
    }
    else if (imgPalette.compare("rgba", Qt::CaseInsensitive) == 0)
    {
        if (colorSupported)
        {
            ...
            default:
                return ito::RetVal(
                    ito::retError,
                    0,
                    tr("DataObject must be of type rgba32 in order to save it to the rgba color "
                       "format.")
                        .toLatin1()
                        .data());
            }
        ...
        else
        {
            return ito::RetVal(
                ito::retError,
                0,
                tr("Image format does not support color values.").toLatin1().data());
        }
    }
        ...
        if (colorSupported)
        {
            ...
            default:
                return ito::RetVal(
                    ito::retError,
                    0,
                    tr("DataObject must be of type rgba32 in order to save it to the rgb color "
                       "format.")
                        .toLatin1()
                        .data());
            }
    ...
    else if (!imgPalette.isEmpty())
    {
        ...
        if (colorSupported)
        {
            if (addAlpha)
            {
                ...
                {
                case ito::tUInt8:
                    ret += itom::io::transformScaledIndex8ToRGBA<ito::uint8>(
                        saveMat, srcData, newPalette.colorVector256);
                    break;

                case ito::tInt8:
                    ret += itom::io::transformScaledIndex8ToRGBA<ito::int8>(
                        saveMat, srcData, newPalette.colorVector256);
                    break;

                case ito::tUInt16:
                    ret += itom::io::transformScaledIndex8ToRGBA<ito::uint16>(
                        saveMat, srcData, newPalette.colorVector256);
                    break;

                case ito::tInt16:
                    ret += itom::io::transformScaledIndex8ToRGBA<ito::int16>(
                        saveMat, srcData, newPalette.colorVector256);
                    break;

                case ito::tUInt32:
                    ret += itom::io::transformScaledIndex8ToRGBA<ito::uint32>(
                        saveMat, srcData, newPalette.colorVector256);
                    break;

                case ito::tInt32:
                    ret += itom::io::transformScaledIndex8ToRGBA<ito::int32>(
                        saveMat, srcData, newPalette.colorVector256);
                    break;

                case ito::tFloat32:
                    ret += itom::io::transformScaledIndex8ToRGBA<ito::float32>(
                        saveMat, srcData, newPalette.colorVector256);
                    break;

                case ito::tFloat64:
                    ret += itom::io::transformScaledIndex8ToRGBA<ito::float64>(
                        saveMat, srcData, newPalette.colorVector256);
                    break;
                ...
                case ito::tRGBA32: {
                    ...
                    ito::DataObject gray = ((ito::DataObject*)dObj)->toGray(ito::tUInt8);
                    ret += itom::io::transformScaledIndex8ToRGBA<ito::uint8>(
                        saveMat, gray.getCvPlaneMat(0), newPalette.colorVector256);
                }
                break;
                ...
                default:
                    return ito::RetVal(
                        ito::retError,
                        0,
                        tr("Data object could not be converted to a gray image with 256 values "
                           "(indexed8). No color palette could be applied.")
                            .toLatin1()
                            .data());
                }
            }
            else
            {
                ...
                {
                case ito::tUInt8:
                    ret += itom::io::transformScaledIndex8ToRGB<ito::uint8>(
                        saveMat, srcData, newPalette.colorVector256);
                    break;

                case ito::tInt8:
                    ret += itom::io::transformScaledIndex8ToRGB<ito::int8>(
                        saveMat, srcData, newPalette.colorVector256);
                    break;

                case ito::tUInt16:
                    ret += itom::io::transformScaledIndex8ToRGB<ito::uint16>(
                        saveMat, srcData, newPalette.colorVector256);
                    break;

                case ito::tInt16:
                    ret += itom::io::transformScaledIndex8ToRGB<ito::int16>(
                        saveMat, srcData, newPalette.colorVector256);
                    break;

                case ito::tUInt32:
                    ret += itom::io::transformScaledIndex8ToRGB<ito::uint32>(
                        saveMat, srcData, newPalette.colorVector256);
                    break;

                case ito::tInt32:
                    ret += itom::io::transformScaledIndex8ToRGB<ito::int32>(
                        saveMat, srcData, newPalette.colorVector256);
                    break;

                case ito::tFloat32:
                    ret += itom::io::transformScaledIndex8ToRGB<ito::float32>(
                        saveMat, srcData, newPalette.colorVector256);
                    break;

                case ito::tFloat64:
                    ret += itom::io::transformScaledIndex8ToRGB<ito::float64>(
                        saveMat, srcData, newPalette.colorVector256);
                    break;
    ...
    if (!ret.containsError())
    {
        ...
        {
            bool test =
                cv::imwrite(fileName.absoluteFilePath().toLatin1().data(), saveMat, save_params);
            if (test == false)
            {
                ret += ito::RetVal(
                    ito::retError, 0, tr("cv::imwrite exited with false!").toLatin1().data());
            }
        }
...
//! saveDataObjectQt
//----------------------------------------------------------------------------------------------------------------------------------
/** saveDataObjectQt method, saves the DataObject into Hard drive as Image using Qt (gif, xbm, xpm
 * only).
 *   @param [in] paramsMand  mandatory argument parameters
 *   @param [in] paramsOpt   optional argument parameters
 *    @param [out] outVals   optional output parameters
 ...
 * as per given Image Format and stores it to specific location provided on Hard drive.
 */
ito::RetVal DataObjectIO::saveDataObjectQt(
    QVector<ito::ParamBase>* paramsMand,
    QVector<ito::ParamBase>* paramsOpt,
    QVector<ito::ParamBase>* /*paramsOut*/,
    const ImageFormat& imageFormat)
        ...
        if (colorSupported)
        {
            ...
            case ito::tRGBA32: {
                ...
                for (int row = 0; row < srcData->rows; ++row)
                {
                    ...
                    {
                        dstLine[col] =
                            qRgba(srcLine[col].r, srcLine[col].g, srcLine[col].b, srcLine[col].a);
                    }
                }
                break;
            }
    ...
    else if (!imgPalette.isEmpty())
    {
        ...
        if (colorSupported)
        {
            if (addAlpha)
            {
                ...
                case ito::tUInt8:
                    ret += itom::io::transformScaledIndex8ToRGBA<ito::uint8>(
                        image, srcData, newPalette.colorVector256);
                    break;
                ...
                case ito::tRGBA32: {
                    ...
                    ito::DataObject gray = ((ito::DataObject*)dObj)->toGray(ito::tUInt8);
                    ret += itom::io::transformScaledIndex8ToRGBA<ito::uint8>(
                        image, gray.getCvPlaneMat(0), newPalette.colorVector256);
                }
                break;
    ...
    if (!ret.containsError())
    {
        ...
        if (test == false)
        {
            ret += ito::RetVal(
                ito::retError,
                0,
                tr("error saving the image file (%1)!")
...
//! loadImageParams
//----------------------------------------------------------------------------------------------------------------------------------
/*static*/ const QString DataObjectIO::loadImageDoc =
 ...
 * DataObject.
 */
ito::RetVal DataObjectIO::loadImageParams(
    QVector<ito::Param>* paramsMand, QVector<ito::Param>* paramsOpt, QVector<ito::Param>* paramsOut)
{
    ito::RetVal retval = prepareParamVectors(paramsMand, paramsOpt, paramsOut);
    if (!retval.containsError())
    {
        ito::Param param = ito::Param(
            ...
            ito::ParamBase::DObjPtr | ito::ParamBase::In | ito::ParamBase::Out,
            NULL,
            tr("DataObject that will be filled with the loaded file content").toLatin1().data());
        paramsMand->append(param);
        param = ito::Param(
            "filename",
            ito::ParamBase::String | ito::ParamBase::In,
 ...
 * passed as parameter from Hard drive and loads a corresponding Itom DataObject.
 */
ito::RetVal DataObjectIO::loadImage(
    QVector<ito::ParamBase>* paramsMand,
    QVector<ito::ParamBase>* paramsOpt,
    QVector<ito::ParamBase>* paramsOut)
{
    ...
    if (fileinfo.suffix().compare("gif", Qt::CaseInsensitive) == 0 ||
        fileinfo.suffix().compare("xbm", Qt::CaseInsensitive) == 0 ||
        fileinfo.suffix().compare("xpm", Qt::CaseInsensitive) == 0)
    {
    ...
    else
    {
        ...
        {
            return ito::RetVal(
                ito::retError, 0, tr("Destination dataObject is invalid.").toLatin1().data());
        }
        ...
        else if (colorFormat.compare("alpha", Qt::CaseInsensitive) == 0)
        {
            ...
            colorFormat.compare("R", Qt::CaseInsensitive) == 0 ||
        ...
        else
        {
            ...
            {
                ret += ito::RetVal(
                    ito::retError, 0, tr("%1").arg((exc.err).c_str()).toLatin1().data());
            }
        }
        ...
        if (!ret.containsError())
        {
            if (image.cols == 0 || image.rows == 0)
            {
                ret += ito::RetVal(
                    ito::retError,
                    0,
                    "Error while reading image. Probably, the bit depth, compression... is not "
                    "supported");
            }
        }
        ...
        if (!ret.containsError())
        {
            ...
            case CV_16UC4:
                ...
                else
                {
                    return ito::RetVal(
                        ito::retError,
                        0,
                        tr("The loaded image has multiple channels with a bitdepth of uint16 each. "
            ...
            default:
                return ito::RetVal(
                    ito::retError,
                    0,
                    tr("Format of the image is currently not supported by itom.")
                        .toLatin1()
                        .data());
            }
            ...
            if (!reduceChannel)
            {
                ...
                else if (image.type() == CV_16UC3)
                {
                    ret += ito::RetVal(
                        ito::retError,
                        0,
                        tr("Color import of channels with uint16 bitdepth not supported.")
                            .toLatin1()
                            .data());
                }
            ...
            else
            {
                ...
                else
                {
                    ...
                    ret += ito::RetVal(
                        ito::retError,
                        0,
                        tr("Color format of the file is currently not compatible with itom. Wait "
                           "for next itom version.")
                            .toLatin1()
                            .data());
                }
                ...
                if (!ret.containsError())
                {
                    if (image.type() == CV_8UC3)
                    {
                        if (colIndex < 0 || colIndex > 3)
                        {
                            ret += ito::RetVal(
                                ito::retError,
                                0,
                                "loaded image does not contain the required channel");
                        }
                        else
                        {
                            ito::uint8* dst = NULL;
                    ...
                    else
                    {
                        ret += ito::RetVal(
                            ito::retError,
                            0,
                            tr("No coloured data object with 3 or 4 color channels has been "
                               "loaded.")
                                .toLatin1()
                                .data());
                    }
 ...
 *
 *   This Function accepts parameters from itom Python application according to specification
 * provided by "loadItomIDOParams" function. It retrieves the xml-compatible raw data from file
 * location passed as parameter from Hard drive and loads a corresponding Itom DataObject.
 */
ito::RetVal DataObjectIO::loadItomIDO(
    QVector<ito::ParamBase>* paramsMand,
    QVector<ito::ParamBase>* /*paramsOpt*/,
    QVector<ito::ParamBase>* /*paramsOut*/)
{
 ...
 *   This Function interacts with itom Python application, constructs plugin functionality, creates
 * necessary parameters (eg. Mandatory and Optional parameters) and their specifications as required
 * for reading a xml-compatible binary and converting into DataObject from Hard drive.
 */
ito::RetVal DataObjectIO::loadItomIDOParams(
    QVector<ito::Param>* paramsMand, QVector<ito::Param>* paramsOpt, QVector<ito::Param>* paramsOut)
{
    ito::RetVal retval = prepareParamVectors(paramsMand, paramsOpt, paramsOut);
    if (!retval.containsError())
 ...
 *   This Function interacts with itom Python application, constructs plugin functionality, creates
 * necessary parameters (eg. Mandatory and Optional parameters) and their specifications as required
 * for converting DataObject into the itom native xml-compatible binary and save it into Hard drive.
 */
ito::RetVal DataObjectIO::saveItomIDOParams(
    QVector<ito::Param>* paramsMand, QVector<ito::Param>* paramsOpt, QVector<ito::Param>* paramsOut)
{
    ito::RetVal retval = prepareParamVectors(paramsMand, paramsOpt, paramsOut);
    if (!retval.containsError())
    {
        ito::Param param = ito::Param(
            ...
            ito::ParamBase::DObjPtr | ito::ParamBase::In,
            NULL,
            tr("Any type of dataObject").toLatin1().data());
        paramsMand->append(param);
        param = ito::Param(
            "filename",
            ito::ParamBase::String | ito::ParamBase::In,
        ...
        param = ito::Param(
            ...
            1,
            0,
            tr("If 0 the complete dataObject is saved (data + metadata) [default], else the filter "
               "saves only metadata")
                .toLatin1()
                .data());
        paramsOpt->append(param);
        param = ito::Param(
            ...
            1,
            0,
            tr("If 0 meta information are saved as clear text, else double tags are saved as "
               "binary")
                .toLatin1()
                .data());
        paramsOpt->append(param);
...
//! saveItomIDO
//----------------------------------------------------------------------------------------------------------------------------------
/** saveItomIDO method, saves the DataObject into Hard drive as xml-compatible raw file using QT
 * XML-Parser.
 *   @param [in] paramsMand  mandatory argument parameters
 *   @param [in] paramsOpt   optional argument parameters
 *    @param [out] outVals   optional output parameters
 *
 *   This Function accepts parameters from itom Python application according to specification
 * provided by "saveItomIDOParams" function. It converts passed DataObject into xml-compatible data
 * and stores it to specific location provided on Hard drive.
 */
ito::RetVal DataObjectIO::saveItomIDO(
    QVector<ito::ParamBase>* paramsMand,
    QVector<ito::ParamBase>* paramsOpt,
    QVector<ito::ParamBase>* /*paramsOut*/)
{
...
//! saveDataToTxt
//----------------------------------------------------------------------------------------------------------------------------------
/*static*/ const QString DataObjectIO::saveDataToTxtDoc = QObject::tr(
    "saves data to an ascii-based file like txt, csv, tsv or space separated values.\n\n\
");


template <typename _Tp>
ito::RetVal doWriteDataD(
    ito::DataObject* dObjSrc,
    QTextStream* dataOut,
    const int asTuple,
    const int noPhys,
    QChar wrapSign,
            ...
            for (int nm = 0; nm < dObjSrc->getNumPlanes(); nm++)
            {
                for (int ny = 0; ny < dObjSrc->getSize(dObjSrc->getDims() - 2); ny++)
                {
                    ...
                    for (int nx = 0; nx < dObjSrc->getSize(dObjSrc->getDims() - 1); nx++)
                    {
                        *dataOut << wrapSign
                                 << QString::number(
                                        cv::saturate_cast<_Tp>((srcPtr[nx] - zoffset) * zscale),
                                        'g',
                                        precision)
                                 << wrapSign;
        ...
        if (!wrapSign.isNull())
        {
            for (int nm = 0; nm < dObjSrc->getNumPlanes(); nm++)
            {
                for (int ny = 0; ny < dObjSrc->getSize(dObjSrc->getDims() - 2); ny++)
                {
                    ...
                    {
                        *dataOut << wrapSign
                                 << QString::number((nx - xoffset) * xscale, 'g', precision)
                                 << wrapSign << separatorSign;
                        *dataOut << wrapSign
                                 << QString::number((ny - xoffset) * yscale, 'g', precision)
                                 << wrapSign << separatorSign;
                        *dataOut << wrapSign
                                 << QString::number(
                                        cv::saturate_cast<_Tp>((srcPtr[nx] - zoffset) * zscale),
        ...
        else
        {
            for (int nm = 0; nm < dObjSrc->getNumPlanes(); nm++)
            {
                for (int ny = 0; ny < dObjSrc->getSize(dObjSrc->getDims() - 2); ny++)
                {
                    ...
                    for (int nx = 0; nx < dObjSrc->getSize(dObjSrc->getDims() - 1); nx++)
                    {
                        *dataOut << QString::number((nx - xoffset) * xscale, 'g', precision)
                                 << separatorSign;
                        *dataOut << QString::number((ny - xoffset) * yscale, 'g', precision)
                                 << separatorSign;
                        *dataOut << QString::number(
                            cv::saturate_cast<_Tp>((srcPtr[nx] - zoffset) * zscale),
                            'g',
...
template <typename _Tp>
ito::RetVal doWriteData(
    const ito::DataObject* dObjSrc,
    QTextStream* dataOut,
    const int asTuple,
    const int noPhys,
    QChar wrapSign,
        ...
        if (!wrapSign.isNull())
        {
            for (int nm = 0; nm < dObjSrc->getNumPlanes(); nm++)
            {
                for (int ny = 0; ny < dObjSrc->getSize(dObjSrc->getDims() - 2); ny++)
                {
                    ...
                    for (int nx = 0; nx < dObjSrc->getSize(dObjSrc->getDims() - 1); nx++)
                    {
                        *dataOut << wrapSign << QString::number((nx - xoffset) * xscale) << wrapSign
                                 << separatorSign;
                        *dataOut << wrapSign << QString::number((ny - xoffset) * yscale) << wrapSign
                                 << separatorSign;
                        *dataOut << wrapSign
                                 << QString::number(
                                        cv::saturate_cast<_Tp>((srcPtr[nx] - zoffset) * zscale))
 ...
 * for converting DataObject into Raw-Text data and save it into Hard drive.
 */
ito::RetVal DataObjectIO::saveDataToTxtParams(
    QVector<ito::Param>* paramsMand, QVector<ito::Param>* paramsOpt, QVector<ito::Param>* paramsOut)
{
    ito::RetVal retval = prepareParamVectors(paramsMand, paramsOpt, paramsOut);
    if (!retval.containsError())
    {
        ito::Param param = ito::Param(
            ...
            ito::ParamBase::DObjPtr | ito::ParamBase::In,
            NULL,
            tr("dataObject holding data to save").toLatin1().data());
        paramsMand->append(param);
        param = ito::Param(
            "filename",
            ito::ParamBase::String | ito::ParamBase::In,
            NULL,
            tr("Destination file name").toLatin1().data());
        paramsMand->append(param);

        //        param = ito::Param("ignoreLines", ito::ParamBase::Int | ito::ParamBase::In, 0,
        //        std::numeric_limits<int>::max(), 0, tr("Ignore the first
        //        n-lines.").toLatin1().data()); paramsOpt->append(param);

        //        param = ito::Param("asMatrix", ito::ParamBase::Int | ito::ParamBase::In, 0, 1, 0,
        //        tr("(1) Try to interpret list elements with 3 elements per row as a matrix or (0)
        //        load as written.").toLatin1().data()); paramsOpt->append(param);
        ...
        param = ito::Param(
            ...
            1,
            0,
            tr("(1) save values as list of points (x, y, z).").toLatin1().data());
        paramsOpt->append(param);
        ...
        param = ito::Param(
            ...
            1,
            0,
            tr("(1) ignore scale and offset").toLatin1().data());
        paramsOpt->append(param);
        ...
        param = ito::Param(
            ...
            ito::ParamBase::String | ito::ParamBase::In,
            " ",
            tr("Uses this as the separator between elements. Default is space \" \".")
                .toLatin1()
                .data());
        paramsOpt->append(param);
        ...
        param = ito::Param(
            ...
            ito::ParamBase::String | ito::ParamBase::In,
            "<guess>",
            tr("Uses this as the sign for decimal numbers. If <guess>, default is system default.")
                .toLatin1()
                .data());
        ...
        param = ito::Param(
            ...
            ito::ParamBase::String | ito::ParamBase::In,
            "",
            tr("Sometimes numbers are wrapped by a sign (.e.g '2.3' or \"4.5\"). If so, indicate "
               "the character(s) that wrap the numbers.")
                .toLatin1()
                .data());
        sm.addItem("");
        param.setMeta(&sm, false);
        ...
        param = ito::Param(
            ...
            ito::ParamBase::String | ito::ParamBase::In,
            "UTF-8",
            tr("encoding of text file, e.g. UTF-8, UTF-16, ISO 8859-1... Default: empty string -> "
               "the encoding is guessed due to a auto-detection of the first 64 bytes in the text "
               "file (using the BOM (Byte Order Mark)).")
                .toLatin1()
                .data());
        paramsOpt->append(param);
    }
 ...
 *
 *   This Function accepts parameters from itom Python application according to specification
 * provided by "loadNistSDF" function. It retrieves the ascii-data from file location passed as
 * parameter from Hard drive and loads a corresponding Itom DataObject.
 */
ito::RetVal DataObjectIO::saveDataToTxt(
    QVector<ito::ParamBase>* paramsMand,
    QVector<ito::ParamBase>* paramsOpt,
    QVector<ito::ParamBase>* /*paramsOut*/)
{
    ...
    else
    {
        ...
        if (encoding != "")
        {
            ...
            {
                ret += ito::RetVal::format(
                    ito::retError, 0, "encoding '%s' is unknown", encoding.toLatin1().data());
            }
        }
        else
        {
        ...
        QLocale local(QLocale::C); // per default a decimal sign is a dot (.) and the thousands
                                   // group separator is (,)
        if (decimalSign == ',')
        {
            local = QLocale(QLocale::German); // if the decimal sign is a comma (,), the thousands
                                              // group separator is assumed to be a dot (.)
        }
...
#else
        textStream.setEncoding(
            QStringConverter::encodingForName(encoding.toLatin1().data()).value());
#endif

        switch (dObjSrc->getType())
        {
        case ito::tUInt8:
            ret += doWriteData<ito::uint8>(
                dObjSrc,
                &textStream,
                asTuple,
                noPhys,
...
//----------------------------------------------------------------------------------------------------------------------------------
/*static*/ const QString DataObjectIO::loadDataFromTxtDoc =
    QObject::tr("loads an ascii-based data file like txt, csv, tsv or space separated values. \n\
\n\
 ...
 * for converting DataObject into Raw-Text data and save it into Hard drive.
 */
ito::RetVal DataObjectIO::loadDataFromTxtParams(
    QVector<ito::Param>* paramsMand, QVector<ito::Param>* paramsOpt, QVector<ito::Param>* paramsOut)
{
    ito::RetVal retval = prepareParamVectors(paramsMand, paramsOpt, paramsOut);
    if (!retval.containsError())
    {
        ito::Param param = ito::Param(
            ...
            ito::ParamBase::DObjPtr | ito::ParamBase::In | ito::ParamBase::Out,
            NULL,
            tr("Empty dataObject").toLatin1().data());
        paramsMand->append(param);
        param = ito::Param(
            "filename",
            ito::ParamBase::String | ito::ParamBase::In,
        ...
        param = ito::Param(
            ...
            std::numeric_limits<int>::max(),
            0,
            tr("Ignore the first n-lines.").toLatin1().data());
        paramsOpt->append(param);
        ...
        param = ito::Param(
            ...
            ito::ParamBase::String | ito::ParamBase::In,
            NULL,
            tr("Uses this as the separator between elements. If NULL, try to guess.")
                .toLatin1()
                .data());
        paramsOpt->append(param);
        ...
        param = ito::Param(
            ...
            ito::ParamBase::String | ito::ParamBase::In,
            "<guess>",
            tr("Uses this as the sign for decimal numbers. If <guess>, try to guess if the decimal "
               "sign is a dot (.) or comma (,).")
                .toLatin1()
                .data());
 ...
 * parameter from Hard drive and loads a corresponding Itom DataObject.
 */
ito::RetVal DataObjectIO::loadDataFromTxt(
    QVector<ito::ParamBase>* paramsMand,
    QVector<ito::ParamBase>* paramsOpt,
    QVector<ito::ParamBase>* /*paramsOut*/)
{
    ...
    else
    {
        ...
        else
        {
            ...
            {
                ret += ito::RetVal(
                    ito::retWarning, 0, "encoding of file can not be guessed. UTF-8 is assumed.");
                encoding = "UTF-8";
            }
        }
...
#endif
            ret += analyseTXTData(
                textStream, *dObjDst, separatorSign, decimalSign, readFlag, ignoreLines);
            if (!ret.containsError())
            {
                if (!dataIn.seek(0))
                {
...
//----------------------------------------------------------------------------------------------------------------------------------
ito::RetVal DataObjectIO::analyseTXTData(
    QTextStream& inFile,
    ito::DataObject& newObject,
    QChar& separator,
    QChar& decimalSign,
    const int flags,
    const int ignoreLines)
{
    ito::RetVal ret(ito::retOk);
    ...
    if (!ret.containsError())
    {
        ...
        if (decimalSign != 0 && decimalSign != '.' && decimalSign != ',')
        {
            ret += ito::RetVal(
                ito::retError,
                0,
                tr("The decimal sign must be '<guess>', '.' or ','.").toLatin1().data());
        }
        else if (decimalSign == separator && !guessDecimal)
        {
            ret += ito::RetVal(
                ito::retError,
                0,
                tr("The decimal sign and the separator must differ.").toLatin1().data());
        }
    }
    ...
    if (!ret.containsError())
    {
        ...
        else if (decimalSign == ',' && guessSeparator)
        {
            if (tabs != 0)
                ...
                separator =
                    '.'; // dot is the last check, since it might also be a thousand-separator
            else
            {
                separator = ' ';
                ret += ito::RetVal(
                    ito::retWarning,
                    0,
                    tr("No separator could be guessed. Maybe, there is only one value per row. The "
                       "separator is set to a space character.")
                        .toLatin1()
                        .data());
            }
        }
        else if (decimalSign == '.' && guessSeparator)
        {
            if (tabs != 0)
                ...
                separator =
                    ','; // comma is the last check, since it might also be a thousand-separator
            else
            {
                separator = ' ';
                ret += ito::RetVal(
            ...
            if (separator == '.')
            {
                if ((tabs + space + sim + comma - remove) > 0)
                {
                    ret += ito::RetVal(
                        ito::retWarning,
                        0,
                        tr("The separator was specified as (.) but other separator signs are also "
                           "possible.")
                            .toLatin1()
                            .data());
                }
            ...
            else if (separator == '\t')
            {
                if ((points + space + sim + comma - remove) > 0)
                {
                    ret += ito::RetVal(
                        ito::retWarning,
                        0,
                        tr("The separator was specified as (tab) but other separator signs are "
                           "also possible.")
                            .toLatin1()
                            .data());
                }
            ...
            else if (separator == ' ')
            {
                if ((tabs + comma + sim + points - remove) > 0)
                {
                    ret += ito::RetVal(
                        ito::retWarning,
                        0,
                        tr("The separator was specified as (space) but other separator signs are "
                           "also possible.")
                            .toLatin1()
                            .data());
                }
        ...
        if (flags & 0x01)
        {
...
#endif
            {
                ret += ito::RetVal(
                    ito::retError,
                    0,
                    tr("The file is no list with 3 columns and N rows or contains invalid "
                       "separators.")
                        .toLatin1()
                        .data());
            }
...
//----------------------------------------------------------------------------------------------------------------------------------
ito::RetVal DataObjectIO::readTXTDataBlock(
    QTextStream& inFile,
    ito::DataObject& newObject,
    const QChar& separator,
    const QChar& decimalSign,
    const int flags,
    const int ignoreLines,
    const QString& wrapSign)
{
    ito::RetVal ret(ito::retOk);
    ...
    QLocale local(QLocale::C); // per default a decimal sign is a dot (.) and the thousands group
                               // separator is (,)

    if (decimalSign == ',')
    {
        local = QLocale(QLocale::German); // if the decimal sign is a comma (,), the thousands group
                                          // separator is assumed to be a dot (.)
    }
    ...
    for (int y = 0; y < ysize; ++y)
    {
        ...
        if (curLineData.size() > xsize)
        {
            ret += ito::RetVal::format(
                ito::retError,
                0,
                tr("Line %i contains more elements than the first analyzed line").toLatin1().data(),
                y + ignoreLines);
            break;
        }
        ...
        for (int x = 0; x < xsizetmp; x++)
        {
            ...
            else
            {
                ...
                {
                    rowPtr[x] = local.toFloat(
                        curline.mid(wrapSignLen, curline.size() - 2 * wrapSignLen), &check);
                    if (!check)
                    {
                        rowPtr[x] = std::numeric_limits<ito::float32>::quiet_NaN();
                    }
...
//! saveNistSDFParams
//----------------------------------------------------------------------------------------------------------------------------------
/*static*/ const QString DataObjectIO::savePtbPRDoc =
    QObject::tr(
 ...
 * for converting DataObject into Raw-Text data and save it into Hard drive.
 */
ito::RetVal DataObjectIO::savePtbPRParams(
    QVector<ito::Param>* paramsMand, QVector<ito::Param>* paramsOpt, QVector<ito::Param>* paramsOut)
{
    ito::RetVal retval = prepareParamVectors(paramsMand, paramsOpt, paramsOut);
    if (!retval.containsError())
    {
        ito::Param param = ito::Param(
            ...
            ito::ParamBase::DObjPtr | ito::ParamBase::In,
            NULL,
            tr("1D data object of any real data type. No invalid values are allowed.")
                .toLatin1()
                .data());
        paramsMand->append(param);
        param = ito::Param(
        ...
        param = ito::Param(
            ...
            12,
            6,
            tr("Number of decimal signs (default: 6).").toLatin1().data());
        paramsOpt->append(param);
        param = ito::Param(
            "ordinateUnit",
            ito::ParamBase::Int | ito::ParamBase::In,
            ...
            1,
            0,
            tr("unit of ordinate (0: nm [default], 1: _m)")
                .replace("_", QLatin1String("\u00B5"))
                .toLatin1()
                .data());
        paramsOpt->append(param);
...
//! savePtbPR
//----------------------------------------------------------------------------------------------------------------------------------
ito::RetVal DataObjectIO::savePtbPR(
    QVector<ito::ParamBase>* paramsMand,
    QVector<ito::ParamBase>* paramsOpt,
    QVector<ito::ParamBase>* /*paramsOut*/)
{
    ...
    ito::DataObject source = ito::dObjHelper::squeezeConvertCheck2DDataObject(
        paramsMand->at(0).getVal<ito::DataObject*>(),
        "sourceObject",
        ito::Range(1, 1),
        ito::Range::all(),
        ret,
    ...
    if (!ret.containsError())
    {
        ...
        else
        {
            ret += ito::RetVal(
                ito::retWarning,
                0,
                "The given input object does not have a metric value unit defined (m, cm, mm, µm, "
                "nm). No correct value transformation to µm or nm can be applied.");
        }
        ...
        else
        {
            ret += ito::RetVal(
                ito::retWarning,
                0,
                "The given input object does not have a metric axis unit defined (m, cm, mm, µm, "
                "nm). No correct lateral unit value can be read. Values are assumed to be in mm.");
        }

        unsigned char key1[] = {'X', '-', 'M', 'a', 0xDF, ' ', '=', ' ', '\0'};
        unsigned char key2[] = {
            ' ', 'X', '-', 'A', 'u', 'f', 'l', 0xF6, 's', 'u', 'n', 'g', ' ', '\0'};
        ...
        for (int i = 0; i < len; ++i)
        {
            ...
            else
            {
                ...
                dataOut.write("\n");
                ret += ito::RetVal::format(
                    ito::retWarning, 0, "invalid value encountered in column %i", (i + 1));
            }
        }
    }
...
ito::RetVal DataObjectIO::loadFrtParams(
    QVector<ito::Param>* paramsMand, QVector<ito::Param>* paramsOpt, QVector<ito::Param>* paramsOut)
{
    ito::RetVal retval = prepareParamVectors(paramsMand, paramsOpt, paramsOut);
    if (!retval.containsError())
    {
        ito::Param param = ito::Param(
            ...
            ito::ParamBase::DObjPtr | ito::ParamBase::In | ito::ParamBase::Out,
            NULL,
            tr("Destination dataObject").toLatin1().data());
        paramsMand->append(param);
        param = ito::Param(
            "filename",
            ito::ParamBase::String | ito::ParamBase::In,
            NULL,
            tr("Source filename").toLatin1().data());
        paramsMand->append(param);
        ...
        param = ito::Param(
            ...
            0x0000ffdf,
            0,
            tr("some files contain more than one dataset. Then pass the bufferType here (its mask "
               "is 0x0000ffdf), if 0 is given, the default buffer type is used.")
                .toLatin1()
                .data());
        paramsOpt->append(param);
        ...
        param = ito::Param(
            ...
            3,
            0,
            tr("some files contain more than one dataset. Its type is selected by 'bufferType'. "
               "Sometimes the result can come from different sensors, then select the sensor index "
               "here.")
                .toLatin1()
                .data());
        paramsOpt->append(param);
        ...
        param = ito::Param(
            ...
            1,
            0,
            tr("If 1 and different buffer types are available, they are printed to the command "
               "line.")
                .toLatin1()
                .data());
        paramsOpt->append(param);
...
/*static*/ ito::RetVal DataObjectIO::loadFrt(
    QVector<ito::ParamBase>* paramsMand,
    QVector<ito::ParamBase>* paramsOpt,
    QVector<ito::ParamBase>* paramsOut)
{
    ...
    const char fileID[] = {
        'F', 'R', 'T', 'M', '_', 'G', 'L', 'I', 'D', 'E', 'R', 'V', '1', '.', '0', '0'}; // 16
                                                                                         // unsigned
                                                                                         // char
    ...
    if (!info.exists())
    {
        retval += ito::RetVal::format(
            ito::retError, 0, "The file '%s' does not exist", paramsMand->at(1).getVal<char*>());
    }
    else if (fileSize < sizeof(fileID) + sizeof(noOfBlocks))
    {
        retval += ito::RetVal::format(
            ito::retError,
            0,
            "The file '%s' is no valid FRT file",
            paramsMand->at(1).getVal<char*>());
    }
    else
    {
        ...
        {
            retval += ito::RetVal::format(
                ito::retError, 0, "Error opening file '%s'", paramsMand->at(1).getVal<char*>());
        }
        else
        {
            ...
            int selectedBufferIndex = -1; //-1 not yet selected, this means take data01buffer, else
                                          // take buffers[selectedBufferIndex]
            ...
            const char* xyTableType[] = {
                ...
                "unknown",
                "Turbo PMac",
                "unknown"}; // special is 41: 100 mm, air bearing linear
            ...
            if (!retval.containsError())
            {
                ...
                for (int block = 0; block < noOfBlocks; ++block)
                {
                    if (data_part + 2 + 4 > data + fileSize)
                    {
                        retval += ito::RetVal(
                            ito::retError,
                            0,
                            "file size of FRT file is too short for the pretended number of "
                            "blocks.");
                        break;
                    }
                    ...
                    if (data_part + blockSize > data + fileSize)
                    {
                        retval += ito::RetVal(
                            ito::retError,
                            0,
                            "file size of FRT file is too short for the pretended block data "
                            "size.");
                        break;
                    }
                    ...
                    if (blockType == 11) // case 11: /*Data_01*/
                    {
                        ...
                        data01buffer.pointers.push_back(
                            std::pair<int, const char*>(0x00000000, data_part));
                        data01buffer.bytesPerBuffer =
                            (data01buffer.sizex * data01buffer.sizey *
                             (data01buffer.bpp == 16 ? 2 : 4));

                        if (data01buffer.sizex >= 0) // size already initialized by block type 102,
                                                     // check the buffer size here now
                        {
                            if (blockSize < data01buffer.bytesPerBuffer)
                            {
                                retval += ito::RetVal(
                                    ito::retError,
                                    0,
                                    "invalid block size of Data_01 block in FRT file.");
                            }
                        }
                    }
                    else if (blockType == 102)
                    {
                        if (blockSize == 12)
                        {
                            ...
                            {
                                retval +=
                                    ito::RetVal(ito::retError, 0, "unknown bit depth in FRT file.");
                            }

                            if (data01buffer.pointers.size() >
                                0) // already initialized pointers, check buffer size now
                            {
                                if ((data01buffer.sizex * data01buffer.sizey *
                                     (data01buffer.bpp == 16 ? 2 : 4)) >
                                    data01buffer.bytesPerBuffer)
                                {
                                    retval += ito::RetVal(
                        ...
                        {
                            retval += ito::RetVal(
                                ito::retError, 0, "wrong size of Imagesize block in FRT file.");
                        }
                    }
                    else if (blockType == 125) /*Multibuffer_01*/
                    {
                        ...
                        int defaultAlias =
                            *((ito::int32*)(&data_part[4])); // alias from current buffer,
                                                             // corresponds to buffer type 11

                        if ((defaultAlias & bufferTypeMask) ==
                            0x0100 /*DIB -> last image, use topography instead */)
                        {
                        ...
                        for (int buf = 0; buf < numBuffers; ++buf)
                        {
                            ...
                            it->sensorCounter = alias & sensorCounterMask;
                            it->pointers.push_back(std::pair<int, const char*>(
                                alias & bufferCounterMask, &data_temp[16]));
                            data_temp += 16;
                            data_temp += it->bytesPerBuffer;

                            if (desiredBufferType == it->bufferType &&
                                desiredSensorCounter == it->sensorCounter)
                            {
                                ...
                                if (it->bpp != 16 && it->bpp != 32)
                                {
                                    retval += ito::RetVal(
                                        ito::retError,
                                        0,
                                        "unknown bit depth of selected buffer in FRT file.");
                                }
                            }
                        }
                        ...
                        if (selectedBufferIndex == -1)
                        {
                            retval += ito::RetVal(
                                ito::retError,
                                0,
                                "the selected bufferType in combination with the sensorCounter "
                                "could not be found in the FRT data file.");
                        }

                        if (printBufferTypes)
                        {
                            std::cout << "Available buffer types in the frt file '"
                                      << paramsMand->at(1).getVal<char*>() << "'\n";
                            std::cout << "---------------------------------------------------------"
                                         "---------------------------------------------------------"
                                         "------------\n\n";
                            ...
                            {
                                std::cout
                                    << "type: " << QByteArray::number(buffers[i].bufferType).data()
                                    << ", sensor counter: "
                                    << QByteArray::number(buffers[i].sensorCounter >> 32).data()
                                    << ", num buffers (planes): "
                                    << QByteArray::number(
                                           (unsigned int)(buffers[i].pointers.size()))
                                           .data();
                ...
                {
                    retval += ito::RetVal(
                        ito::retError, 0, "mandatory block Imagesize is missing in FRT file.");
                }
                ...
                if (!retval.containsError())
                {
                    ...
                    if (selectedBufferIndex == -1) // take data 01
                    {
                        ...
                        memcpy(
                            obj.rowPtr(0, 0),
                            data01buffer.pointers[0].second,
                            data01buffer.bytesPerBuffer);
                    ...
                    else
                    {
                        ...
                        {
                            obj = ito::DataObject(
                                usedBuffer->sizey, usedBuffer->sizex, dataType); // 2d object
                            memcpy(
                                obj.rowPtr(0, 0),
                                usedBuffer->pointers[0].second,
                                usedBuffer->bytesPerBuffer);
                        }
                        else
                        {
                            axisX = 2;
                            ...
                            for (int z = 0; z < usedBuffer->pointers.size(); ++z)
                            {
                                ...
                                {
                                    // search for the lowest, still unused buffer counter and copy
                                    // it to sort for the buffer counters
                                    if (usedBuffer->pointers[z2].first > currentPlane)
                                    {
                                        currentPlane = usedBuffer->pointers[z2].first;
                                        memcpy(
                                            obj.rowPtr(z, 0),
                                            usedBuffer->pointers[z2].second,
                                            usedBuffer->bytesPerBuffer);
                                        break;
                                    }
                                }
                    ...
                    for (int block = 0; block < noOfBlocks && !error; ++block)
                    {
                        ...
                        case 103: /*Scansize_01*/
                            if (blockSize == 44)
                            {
                                ...
                                scanSize.rangey =
                                    *((ito::float64*)(&data_part[8])); // sometimes rangey is not
                                                                       // defined in older files,
                                                                       // factorrangey should always
                                                                       // be preferred.
                                ...
                                // usually rangey should be rangex * factorrangey. If this is not
                                // the case, we warn the use and reset reangey.
                                if (ito::isZeroValue<ito::float64>(
                                        scanSize.rangey - scanSize.rangex * scanSize.factorrangey,
                                        std::numeric_limits<ito::float64>::epsilon()) == false)
                                {
                                    retval += ito::RetVal(
                                        ito::retWarning,
                                        0,
                                        "rangey in block Scansize did not correspond to specs and "
                                        "was modified to (rangex * factorrangey)");
                                    scanSize.rangey = scanSize.rangex * scanSize.factorrangey;
                                }
                            ...
                            {
                                retval += ito::RetVal(
                                    ito::retError, 0, "wrong size of Scansize block in FRT file.");
                                error = true;
                            }
                            break;
                        ...
                        case 108: /*Sensor_01*/
                            if (blockSize == 12)
                            {
                                ...
                                if (!block171detected) // zscaling and offset not yet loaded from
                                                       // block171
                                {
                        ...
                        case 110: /*Hardware_01*/
                            if (blockSize == 12)
                            {
                                ...
                                temp = scanXYType == 41 ? "100 mm, air bearing linear"
                                                        : xyTableType[qBound(0, scanXYType, 11)];
                        ...
                        case 113: /*zoffset_01*/
                        {
                            ...
                            {
                                warnings << "wrong block size for 'zoffset' block. This block is "
                                            "ignored.";
                            }
                            break;
                        }
                        ...
                        case 129: /*LAYER_01*/
                        {
                            ...
                            if (obj.getDims() == 3)
                            {
                                ...
                                obj.setAxisOffset(
                                    0, -(0.5 * r0) / rRest); // center point of first layer
                            }
                            break;
                        }
                        ...
                        case 179: /*HEATING_CHAMBER*/
                        {
                            ...
                            {
                                warnings << "wrong block size for 'heating_chamber' block. This "
                                            "block is ignored.";
                            }
                            break;
                        }
                        default:
                            // warnings << QString("block type %1 unknown in FRT file. It will be
                            // ignored.").arg(blockType);
                            break;
                        }
                    ...
                    {
                        retval +=
                            ito::RetVal(ito::retWarning, 0, warnings.join("\n").toLatin1().data());
                    }

                    if (!block102detected || !block103detected || !block108detected ||
                        !block11detected)
                    {
                        retval +=
                            ito::RetVal(ito::retError, 0, "missing mandatory blocks in FRT file.");
                    }

                    if (!retval.containsError() && usedBuffer->alias != 0 && !block171detected)
                    {
                        // retval += ito::RetVal(ito::retWarning, 0, "Data from a multibuffer
                        // section was loaded, but no scale or offset information found in
                        // Multibuffer_02 block found. Default values are taken."); the warning was
                        // commented, since many *.frt files have block 125 but not block 171.
                    ...
                    if (!retval.containsError())
                    {
                        if (sensor.zscaling != 1.0 || zOffset != 0)
                        {
                            ...
                            retval += obj.convertTo(
                                objConverted, ito::tFloat64, sensor.zscaling, zOffset);
                            ...
                            if (firstValidValue >= 0 && lastValidValue >= 0)
                            {
                                ...
                                for (int z = 0; z < obj.getNumPlanes(); ++z)
                                {
                                    ...
                                    if (obj.getType() == ito::tUInt16)
                                    {
                                        ...
                                        {
                                            if (srcPtr[i] < firstValidValue ||
                                                srcPtr[i] > lastValidValue)
                                            {
                                                // usually scrPtr[i] == 0: not measured, srcPtr[i]
                                                // == 1: measured, but invalid
                                                destPtr[i] =
