...
//----------------------------------------------------------------------------------------------------------------------------------
DockWidgetIntelRealSense::DockWidgetIntelRealSense(ito::AddInDataIO *grabber) :
    ...
    m_firstRun(true)
{
	...
	ui.paramEditorWidget->setPlugin(plugin);
}

//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetIntelRealSense::parametersChanged(QMap<QString, ito::Param> params)
{
    if (m_firstRun)
    {
        //first time call
...
//----------------------------------------------------------------------------------------------------------------------------------
// void DockWidgetIntelRealSense::on_contrast_valueChanged(int i)
// {
    // if (!m_inEditing)
    // {
        // m_inEditing = true;
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetIntelRealSense::identifierChanged(const QString &identifier)
{
