...
PTP_EXPORT uint16_t ptp_usb_sendreq(PTPParams* params, PTPContainer* req);
PTP_EXPORT uint16_t ptp_usb_senddata(PTPParams* params, PTPContainer* ptp,
				unsigned char *data, unsigned int size);
PTP_EXPORT uint16_t ptp_usb_getresp(PTPParams* params, PTPContainer* resp);
PTP_EXPORT uint16_t ptp_usb_getdata(PTPParams* params, PTPContainer* ptp,
				unsigned int *getlen, unsigned char **data);
PTP_EXPORT uint16_t ptp_usb_event_check(PTPParams* params, PTPContainer* event);
PTP_EXPORT uint16_t ptp_usb_event_wait(PTPParams* params, PTPContainer* event);

PTP_EXPORT uint16_t ptp_getdeviceinfo(PTPParams* params, PTPDeviceInfo* deviceinfo);

PTP_EXPORT uint16_t ptp_opensession(PTPParams *params, uint32_t session);
PTP_EXPORT uint16_t ptp_closesession(PTPParams *params);

PTP_EXPORT uint16_t ptp_getstorageids(PTPParams* params, PTPStorageIDs* storageids);
PTP_EXPORT uint16_t ptp_getstorageinfo(PTPParams* params, uint32_t storageid,
				PTPStorageInfo* storageinfo);

PTP_EXPORT uint16_t ptp_getobjecthandles(PTPParams* params, uint32_t storage,
				uint32_t objectformatcode,
				uint32_t associationOH,
				PTPObjectHandles* objecthandles);

PTP_EXPORT uint16_t ptp_getobjectinfo(PTPParams *params, uint32_t handle,
				PTPObjectInfo* objectinfo);

PTP_EXPORT uint16_t ptp_getobject(PTPParams *params, uint32_t handle,
				char** object);
PTP_EXPORT uint16_t ptp_getthumb(PTPParams *params, uint32_t handle,
				char** object);

PTP_EXPORT uint16_t ptp_deleteobject(PTPParams* params, uint32_t handle,
				uint32_t ofc);

PTP_EXPORT uint16_t ptp_sendobjectinfo(PTPParams* params, uint32_t* store,
				uint32_t* parenthandle, uint32_t* handle,
				PTPObjectInfo* objectinfo);
PTP_EXPORT uint16_t ptp_sendobject(PTPParams* params, char* object,
				uint32_t size);

PTP_EXPORT uint16_t ptp_initiatecapture(PTPParams* params, uint32_t storageid,
				uint32_t ofc);

PTP_EXPORT uint16_t ptp_getdevicepropdesc(PTPParams* params, uint16_t propcode,
				PTPDevicePropDesc *devicepropertydesc);
PTP_EXPORT uint16_t ptp_getdevicepropvalue(PTPParams* params, uint16_t propcode,
				void** value, uint16_t datatype);
PTP_EXPORT uint16_t ptp_setdevicepropvalue(PTPParams* params, uint16_t propcode,
				void* value, uint16_t datatype);


PTP_EXPORT uint16_t ptp_sendgenericrequest(PTPParams* params, uint16_t reqcode,
				uint32_t* reqparams, char** data,
				uint32_t direction, long sendlen);


PTP_EXPORT uint16_t ptp_ek_sendfileobjectinfo(PTPParams* params, uint32_t* store,
				uint32_t* parenthandle, uint32_t* handle,
				PTPObjectInfo* objectinfo);
...
PTP_EXPORT uint16_t ptp_canon_startshootingmode(PTPParams* params);
PTP_EXPORT uint16_t ptp_canon_endshootingmode(PTPParams* params);

PTP_EXPORT uint16_t ptp_canon_viewfinderon(PTPParams* params);
PTP_EXPORT uint16_t ptp_canon_viewfinderoff(PTPParams* params);

PTP_EXPORT uint16_t ptp_canon_reflectchanges(PTPParams* params, uint32_t p1);
PTP_EXPORT uint16_t ptp_canon_checkevent(PTPParams* params,
				PTPUSBEventContainer* event, int* isevent);
PTP_EXPORT uint16_t ptp_canon_focuslock(PTPParams* params);
PTP_EXPORT uint16_t ptp_canon_focusunlock(PTPParams* params);
...
/* Nikon extensions */
PTP_EXPORT uint16_t ptp_nikon_setcontrolmode(PTPParams* params, uint32_t mode);
PTP_EXPORT uint16_t ptp_nikon_directcapture(PTPParams* params, uint32_t unknown);
PTP_EXPORT uint16_t ptp_nikon_checkevent(PTPParams* params,
				PTPUSBEventContainer** event, uint16_t* evnum);
PTP_EXPORT uint16_t ptp_nikon_keepalive(PTPParams* params);


/* Non PTP protocol functions */
PTP_EXPORT int ptp_operation_issupported(PTPParams* params, uint16_t operation);
PTP_EXPORT int ptp_property_issupported(PTPParams* params, uint16_t property);

PTP_EXPORT void ptp_free_devicepropdesc(PTPDevicePropDesc* dpd);
PTP_EXPORT void ptp_perror(PTPParams* params, uint16_t error);
PTP_EXPORT const char* ptp_get_datatype_name(PTPParams* params, uint16_t dt);
PTP_EXPORT const char* ptp_get_operation_name(PTPParams* params, uint16_t oc);
PTP_EXPORT const char* ptp_prop_getname(PTPParams* params, uint16_t dpc);

/* Properties handling functions */
PTP_EXPORT const char* ptp_prop_getdesc(PTPParams* params, PTPDevicePropDesc *dpd,
					void *val);
PTP_EXPORT const char* ptp_prop_getdescbystring
				(PTPParams* params,PTPDevicePropDesc *dpd,
				const char *strval);

PTP_EXPORT const char * ptp_prop_tostr(PTPParams* params, PTPDevicePropDesc *dpd,
					void *val);
PTP_EXPORT uint16_t ptp_prop_getcodebyname(PTPParams* params, char* propname);
PTP_EXPORT const char* ptp_prop_getvalbyname
