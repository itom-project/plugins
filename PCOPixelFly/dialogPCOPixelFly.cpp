...
//----------------------------------------------------------------------------------------------------------------------------------
int dialogPCOPixelFly::getVals(QMap<QString, ito::Param> *paramVals)
{
...
//----------------------------------------------------------------------------------------------------------------------------------
int dialogPCOPixelFly::sendVals()
{
...
//----------------------------------------------------------------------------------------------------------------------------------
void dialogPCOPixelFly::valuesChanged(QMap<QString, ito::Param> params)
{
    getVals(&params);
    return;
}
 ...
 * \warning    NA
*/
void dialogPCOPixelFly::on_pushButton_setSizeXMax_clicked()
{
    int inttemp = 0;
 ...
 * \warning    NA
*/
void dialogPCOPixelFly::on_pushButton_setSizeYMax_clicked()
{
    int inttemp = 0;
 ...
 * \warning    NA
*/
void dialogPCOPixelFly::on_applyButton_clicked()
{
 ...
 * \warning    NA
*/
void dialogPCOPixelFly::on_spinBox_x0_valueChanged(int value)
{
 ...
 * \warning    NA
*/
void dialogPCOPixelFly::on_spinBox_x1_valueChanged(int value)
{
 ...
 * \warning    NA
*/
void dialogPCOPixelFly::on_spinBox_y0_valueChanged(int value)
{
 ...
 * \warning    NA
*/
void dialogPCOPixelFly::on_spinBox_y1_valueChanged(int value)
{
 ...
 * \warning    NA
*/
void dialogPCOPixelFly::on_spinBox_binX_valueChanged(int value)
{
 ...
 * \warning    NA
*/
void dialogPCOPixelFly::on_spinBox_binY_valueChanged(int value)
{
    ui.groupBoxSize->setTitle("Size (Binning changed, press apply or save)");
    ui.groupBoxSize->setEnabled(false);
    return;
