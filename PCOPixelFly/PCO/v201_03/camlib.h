...
int (*map_buffer)(HANDLE hdriver,int bufnr,int size,int offset,DWORD *linadr); //for 32bit
int (*map_buffer_ex)(HANDLE hdriver, int bufnr, int size, int offset, void** linadr); //for 64bit
int (*unmap_buffer)(HANDLE hdriver,int bufnr); //for 32 and 64bit
