...
PCL_INSTANTIATE_SampleConsensusModelStick(struct pcl::PointNormal)
PCL_INSTANTIATE_SampleConsensusModelStick(struct pcl::PointXYZINormal)
PCL_INSTANTIATE_SampleConsensusModelStick(struct pcl::PointXYZRGBNormal)
