...
//----------------------------------------------------------------------------------------------------------------------------------
DockWidgetDummyMultiChannelGrabber::DockWidgetDummyMultiChannelGrabber(ito::AddInDataIO *grabber) :
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetDummyMultiChannelGrabber::identifierChanged(const QString &identifier)
{
    ui.lblID->setText(identifier);
}

//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetDummyMultiChannelGrabber::on_spinBox_gain_valueChanged(int d)
{
    if (!m_inEditing)
    {
        m_inEditing = true;
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetDummyMultiChannelGrabber::on_spinBox_offset_valueChanged(int d)
{
    if (!m_inEditing)
    {
        m_inEditing = true;
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetDummyMultiChannelGrabber::on_doubleSpinBox_integration_time_valueChanged(double d)
{
    if (!m_inEditing)
    {
        m_inEditing = true;
