...
#define PLUGIN_VERSION              CREATE_VERSION(1, 0, 0)
#define PLUGIN_MIN_ITOM_VERSION     CREATE_VERSION(4, 1, 0)
...
#define PLUGIN_AUTHOR               "J. Drozella, ITO, Universität Stuttgart"
#define PLUGIN_COPYRIGHT            "(C) 2020, ITO, Universität Stuttgart"
#define PLUGIN_NAME                 "OceanOpticsSpec"
