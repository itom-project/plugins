...
CVBInterface::CVBInterface(QObject *parent)
{
 ...
 This plugin has been tested with DALSA Genie HM1400 and Xenics Bobcat 640 GigE."; 
    ...
    ito::Param param( "scanForCameras", ito::ParamBase::Int | ito::ParamBase::In, 0, 1, 0, tr("If 1 scan for new cameras, else take the last opened camera (default)").toLatin1().data());
...
// this macro registers the class IDSInterface with the name IDSuEye as plugin for the Qt-System (see Qt-DOC)
    ...
    Q_EXPORT_PLUGIN2(CommonVisionBlox, CVBInterface)
#endif
