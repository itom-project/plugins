...
During the installation, the necessary Vimba DLLs (VimbaC.dll and VimbaCPP.dll) should be copyd into the system directory of Windows, such that no further steps need to be
