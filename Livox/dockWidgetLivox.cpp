...
//----------------------------------------------------------------------------------------------------------------------------------
DockWidgetLivox::DockWidgetLivox(ito::AddInDataIO *grabber) :
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetLivox::parametersChanged(QMap<QString, ito::Param> params)
{
    if (m_firstRun)
    {
        //first time call
...
//----------------------------------------------------------------------------------------------------------------------------------
// void DockWidgetLivox::on_contrast_valueChanged(int i)
// {
    // if (!m_inEditing)
    // {
        // m_inEditing = true;
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetLivox::identifierChanged(const QString &identifier)
{
