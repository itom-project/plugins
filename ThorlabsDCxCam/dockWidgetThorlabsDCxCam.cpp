...
//----------------------------------------------------------------------------------------------------------------------------------
DockWidgetThorlabsDCxCam::DockWidgetThorlabsDCxCam(ito::AddInDataIO *grabber) :
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetThorlabsDCxCam::parametersChanged(QMap<QString, ito::Param> params)
{
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetThorlabsDCxCam::on_sliderExposure_valueChanged(double value)
{
    if (!m_inEditing)
    {
        m_inEditing = true;
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetThorlabsDCxCam::on_sliderGain_valueChanged(double value)
{
    if (!m_inEditing)
    {
        m_inEditing = true;
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetThorlabsDCxCam::on_sliderGainRed_valueChanged(double value)
{
    if (!m_inEditing)
    {
        m_inEditing = true;
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetThorlabsDCxCam::on_sliderGainGreen_valueChanged(double value)
{
    if (!m_inEditing)
    {
        m_inEditing = true;
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetThorlabsDCxCam::on_sliderGainBlue_valueChanged(double value)
{
    if (!m_inEditing)
    {
        m_inEditing = true;
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetThorlabsDCxCam::on_sliderOffset_valueChanged(double value)
{
    if (!m_inEditing)
    {
        m_inEditing = true;
