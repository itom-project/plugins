...
#ifndef DIALOGTHORLABSDCXCAM_H
#define DIALOGTHORLABSDCXCAM_H
...
#include "ui_dialogThorlabsDCxCam.h"
...
class DialogThorlabsDCxCam : public ito::AbstractAddInConfigDialog
{
    Q_OBJECT

    public:
        DialogThorlabsDCxCam(ito::AddInBase *grabber);
        ~DialogThorlabsDCxCam() {};
