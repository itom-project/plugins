...
//----------------------------------------------------------------------------------------------------------------------------------
  ...
  *\class    AvantesSDK
  */
class AvantesSDK : public ito::AddInGrabber
{
    Q_OBJECT
    ...
    public:
        friend class AvantesSDKInterface;
    ...
    private:
        ...
        unsigned short nrPixels;
        AvsHandle hDevice;

        //ito::AddInDataIO *m_pUsb;   // libUSB handler
        bool m_isgrabbing;
        ...
        std::string returnErrorCodes(int errCode);
...
//----------------------------------------------------------------------------------------------------------------------------------
  ...
  *
  */
class AvantesSDKInterface : public ito::AddInInterfaceBase
{
    Q_OBJECT
