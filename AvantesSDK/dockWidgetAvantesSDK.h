...
#ifndef DOCKWIDGETAVANTESSDK_H
#define DOCKWIDGETAVANTESSDK_H
...
#include "ui_dockWidgetAvantesSDK.h"

class DockWidgetAvantesSDK : public ito::AbstractAddInDockWidget
{
    Q_OBJECT

    public:
        DockWidgetAvantesSDK(ito::AddInDataIO *grabber);
        ~DockWidgetAvantesSDK() {};

    private:
        Ui::DockWidgetAvantesSDK ui;
