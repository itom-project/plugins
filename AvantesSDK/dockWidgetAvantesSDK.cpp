...
//----------------------------------------------------------------------------------------------------------------------------------
DockWidgetAvantesSDK::DockWidgetAvantesSDK(ito::AddInDataIO *grabber) :
...
//----------------------------------------------------------------------------------------------------------------------------------
 void DockWidgetAvantesSDK::parametersChanged(QMap<QString, ito::Param> params)
 {
    if (m_firstRun)
    {
		m_inEditing = true;
...
SDK) and subtracts different mean values for odd and even pixels.");
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetAvantesSDK::identifierChanged(const QString &identifier)
{
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetAvantesSDK::on_doubleSpinBox_integration_time_valueChanged(double d)
{
    if (!m_inEditing)
    {
        m_inEditing = true;
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetAvantesSDK::on_rangeWidget_ROI_maximumValueChanged(int value)
{
    if (!m_inEditing)
    {
        m_inEditing = true;
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetAvantesSDK::on_rangeWidget_ROI_minimumValueChanged(int value)
{
    if (!m_inEditing)
    {
        m_inEditing = true;
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetAvantesSDK::on_spinBox_average_valueChanged(int value)
{
    if (!m_inEditing)
    {
        m_inEditing = true;
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetAvantesSDK::on_comboDarkCorrection_currentIndexChanged(int d)
{
    if (!m_inEditing)
    {
        m_inEditing = true;
