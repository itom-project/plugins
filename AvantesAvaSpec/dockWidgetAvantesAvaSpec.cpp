...
//----------------------------------------------------------------------------------------------------------------------------------
DockWidgetAvantesAvaSpec::DockWidgetAvantesAvaSpec(ito::AddInDataIO *grabber) :
...
//----------------------------------------------------------------------------------------------------------------------------------
 void DockWidgetAvantesAvaSpec::parametersChanged(QMap<QString, ito::Param> params)
 {
    if (m_firstRun)
    {
		m_inEditing = true;
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetAvantesAvaSpec::identifierChanged(const QString &identifier)
{
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetAvantesAvaSpec::on_doubleSpinBox_integration_time_valueChanged(double d)
{
    if (!m_inEditing)
    {
        m_inEditing = true;
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetAvantesAvaSpec::on_rangeWidget_ROI_maximumValueChanged(int value)
{
    if (!m_inEditing)
    {
        m_inEditing = true;
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetAvantesAvaSpec::on_rangeWidget_ROI_minimumValueChanged(int value)
{
    if (!m_inEditing)
    {
        m_inEditing = true;
...
//----------------------------------------------------------------------------------------------------------------------------------
void DockWidgetAvantesAvaSpec::on_spinBox_average_valueChanged(int value)
{
    if (!m_inEditing)
    {
        m_inEditing = true;
