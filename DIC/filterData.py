...
print("Cnt 0 : {0}      {1}          {2}           {3}      {4}".format(apprCnt0, OptCnt0, NormCnt0, CellCnt9, IntCnt2))
print("Mean 0: {0}      {1}          {2}           {3}      {4}".format(apprMean0, OptMean0, NormMean0, CellMean9, IntMean2))
print("Sdev 0: {0}      {1}          {2}           {3}      {4}".format(apprVar0, OptVar0, NormVar0, CellVar9, IntVar2))
print("")
print("Cnt 1 : {0}      {1}          {2}           {3}      {4}".format(apprCnt1, OptCnt1, NormCnt1, CellCnt33, IntCnt3))
print("Mean 1: {0}      {1}          {2}           {3}      {4}".format(apprMean1, OptMean1, NormMean1, CellMean33, IntMean3))
print("Sdev 1: {0}      {1}          {2}           {3}      {4}".format(apprVar1, OptVar1, NormVar1, CellVar33, IntVar3))
print("")
print("Cnt 2 :                                     {0}      {1}".format(CellCnt65, IntCnt5))
print("Mean 2:                                     {0}      {1}".format(CellMean65, IntMean5))
print("Sdev 2:                                     {0}      {1}".format(CellVar65, IntVar5))
print("")
print("Cnt 3 :                                              {0}".format(IntCnt7))
print("Mean 3:                                              {0}".format(IntMean7))
print("Sdev 3:                                              {0}".format(IntVar7))
