 ...
 *
 * \sa QCam::showConfDialog(void)
 * \date	Oct.2011
 * \author	Wolfram Lyda
 * \warning	NA
*/
int DialogQCam::setVals(QMap<QString, ito::Param> *paramVals)
{
    QVariant qvar;
...
//----------------------------------------------------------------------------------------------------------------------------------
int DialogQCam::getVals(QMap<QString, ito::Param> *paramVals)
{
    QVariant qvar;
