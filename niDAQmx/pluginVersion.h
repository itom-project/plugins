...
#define PLUGIN_AUTHOR         "Martin Hoppe, ITO, University Stuttgart; Dan Nessett, Unaffiliated; M. Gronle, Unaffiliated"
#define PLUGIN_COPYRIGHT      "(C) 2019, ITO Uni Stuttgart"
