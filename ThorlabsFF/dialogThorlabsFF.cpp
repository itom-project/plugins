...
//----------------------------------------------------------------------------------------------------------------------------------
DialogThorlabsFF::DialogThorlabsFF(ito::AddInBase *grabber) :
...
//----------------------------------------------------------------------------------------------------------------------------------
void DialogThorlabsFF::parametersChanged(QMap<QString, ito::Param> params)
{
...
//----------------------------------------------------------------------------------------------------------------------------------
ito::RetVal DialogThorlabsFF::applyParameters()
{
...
//---------------------------------------------------------------------------------------------------------------------
void DialogThorlabsFF::on_buttonBox_clicked(QAbstractButton* btn)
{
    ito::RetVal retValue(ito::retOk);
...
//---------------------------------------------------------------------------------------------------------------------
void DialogThorlabsFF::enableDialog(bool enabled)
{
    //e.g.
