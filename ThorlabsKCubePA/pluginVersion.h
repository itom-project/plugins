...
#define PLUGIN_COMPANY        "TRUMPF Laser & Systemtechnik GmbH, Ditzingen"
#define PLUGIN_COPYRIGHT      "(C) 2019, TRUMPF Laser & Systemtechnik GmbH"
#define PLUGIN_NAME           "Thorlabs KCube Position Aligner"
