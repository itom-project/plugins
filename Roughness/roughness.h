    ...
    public:
        ...
        struct RoughnessParams
        {
            ...
            { 
                ...
                Use5SamplesWithCutOffWavelength = 1, //split the measurement length (less the endeffects) into 5 samples with the length of the cut-off-wavelength. If the measurement length is longer, the end is omitted. If it is too short, an error is raisen.
                SplitIntoNSamplesWithCutOffWavelength = 2 //same as Use5SamplesWithCutOffWavelength but creates N samples and raises an error if N < 1.
            };
